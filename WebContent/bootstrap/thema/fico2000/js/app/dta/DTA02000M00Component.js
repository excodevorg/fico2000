var DTA02000M00 = new DTA02000M00Component();

var boardCode = 'FAS900202';

var boardMngService = new BoardMngService(true);

function DTA02000M00Component() {

};

DTA02000M00Component.prototype.ngOnInit = function () {
    $("#grid-list").bootgrid();
    DTA02000M00.onSearch();
};

DTA02000M00Component.prototype.onSearch = function () {
