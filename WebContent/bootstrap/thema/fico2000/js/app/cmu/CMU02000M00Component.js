var CMU02000M00 = new CMU02000M00Component();

var boardCode = 'FAS900206';

var boardMngService = new BoardMngService(true);

function CMU02000M00Component() {

};

CMU02000M00Component.prototype.ngOnInit = function () {
    $("#grid-list").bootgrid();
    CMU02000M00.onSearch();
};

CMU02000M00Component.prototype.onSearch = function () {
