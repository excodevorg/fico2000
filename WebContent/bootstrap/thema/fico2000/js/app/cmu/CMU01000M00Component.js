var CMU01000M00 = new CMU01000M00Component();

var boardCode = 'FAS900204';

var boardMngService = new BoardMngService(true);

function CMU01000M00Component() {

};

CMU01000M00Component.prototype.ngOnInit = function () {
    $("#grid-list").bootgrid();
    CMU01000M00.onSearch();
};

CMU01000M00Component.prototype.onSearch = function () {
