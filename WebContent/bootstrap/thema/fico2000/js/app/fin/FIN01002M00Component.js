...
FIN01002M00Component.prototype.ngOnInit = function () {
    ...
    if (finCom.gb == 'old') {
        finService.getEntpFinInfoTypeMap(finCom.userid, finCom.bzn, finCom.stacYy, FIN01002M00.finCallback);
    } else {
        finService.getEntpFinInfoModel(finCom.userid, FIN01002M00.finCallback);
    }
    ...
    $("#initFAS0301").click(function() {
        FIN01002M00.initFAS0301();
    });

    $("#saveFAS0301").click(function() {
        FIN01002M00.saveFAS0301();
    });

    $("#initFAS0302").click(function() {
        FIN01002M00.initFAS0302();
    });

    $("#saveFAS0302").click(function() {
        FIN01002M00.saveFAS0302();
    });

    $("#initFAS0303").click(function() {
        FIN01002M00.initFAS0303();
    });

    $("#saveFAS0303").click(function() {
        FIN01002M00.saveFAS0303();
    });

    $("#initFAS0304").click(function() {
        FIN01002M00.initFAS0304();
    });

    $("#saveFAS0304").click(function() {
        FIN01002M00.saveFAS0304();
    });
...
FIN01002M00Component.prototype.finCallback = function(data) {
    
    if (data != null) {
        var res = JSON.parse(data);

        if (res.success) {
            FIN01002M00.onBalance(res);
            FIN01002M00.onIncome(res);
            FIN01002M00.onCost(res);
            FIN01002M00.onAddedValue(res);
            FIN01002M00.onView();
...
FIN01002M00Component.prototype.onBalance = function(res) {
...
FIN01002M00Component.prototype.onIncome = function(res) {
...
FIN01002M00Component.prototype.onCost = function(res) {
...
FIN01002M00Component.prototype.onAddedValue = function(res) {
        ...
        FIN01002M00.setAddValue();

    };


FIN01002M00Component.prototype.setAddValue = function() { 
...
FIN01002M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN01002M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN01002M00Component.prototype.getBsTotal = function(accd) {
...
FIN01002M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN01002M00Component.prototype.getCostTotal = function(accd) {
...
FIN01002M00Component.prototype.getCostTotal01 = function(accd) {
...
FIN01002M00Component.prototype.onView = function() {
    $("#FAS03010101s").html(FIN01002M00.finInputList(FAS03010101s));
    $("#FAS03010102s").html(FIN01002M00.finInputList(FAS03010102s));
    $("#FAS03010201s").html(FIN01002M00.finInputList(FAS03010201s));
    $("#FAS03010202s").html(FIN01002M00.finInputList(FAS03010202s));
    $("#FAS03010203s").html(FIN01002M00.finInputList(FAS03010203s));
    $("#FAS03010204s").html(FIN01002M00.finInputList(FAS03010204s));
    $("#FAS03010301s").html(FIN01002M00.finInputList(FAS03010301s));
    $("#FAS03010401s").html(FIN01002M00.finInputList(FAS03010401s));
    $("#FAS03010501s").html(FIN01002M00.finInputList(FAS03010501s));

    $("#FAS03020101s").html(FIN01002M00.finInputList(FAS03020101s));
    $("#FAS03020201s").html(FIN01002M00.finInputList(FAS03020201s));
    $("#FAS03020301s").html(FIN01002M00.finInputList(FAS03020301s));
    $("#FAS03020401s").html(FIN01002M00.finInputList(FAS03020401s));
    $("#FAS03020501s").html(FIN01002M00.finInputList(FAS03020501s));

    $("#FAS03030101s").html(FIN01002M00.finInputList(FAS03030101s));
    $("#FAS03030201s").html(FIN01002M00.finInputList(FAS03030201s));
    $("#FAS03030301s").html(FIN01002M00.finInputList(FAS03030301s));

    FIN01002M00.onAddView();

};

FIN01002M00Component.prototype.onAddView = function() {

    $("#BsTotal_FAS030101").html(FIN01002M00.getBsTotal('FAS030101'));
    $("#BsTotal_FAS030102").html(FIN01002M00.getBsTotal('FAS030102'));
    $("#BsTotal_FAS030101T").html(FIN01002M00.getBsTotal('FAS030101T'));

    $("#BsTotal_FAS030103").html(FIN01002M00.getBsTotal('FAS030103'));
    $("#BsTotal_FAS030104").html(FIN01002M00.getBsTotal('FAS030104'));
    $("#BsTotal_FAS030105").html(FIN01002M00.getBsTotal('FAS030105'));
    $("#BsTotal_FAS030103T").html(FIN01002M00.getBsTotal('FAS030103T'));

    $("#IncomeTotal_FAS0302010101").html(FIN01002M00.getIncomeTotal('FAS0302010101'));
    $("#IncomeTotal_FAS0302010102").html(FIN01002M00.getIncomeTotal('FAS0302010102'));
    $("#IncomeTotal_amslTtalPlAmt").html(FIN01002M00.getIncomeTotal('amslTtalPlAmt'));
    $("#IncomeTotal_FAS03020201").html(FIN01002M00.getIncomeTotal('FAS03020201'));
    $("#IncomeTotal_bsopPlAmt").html(FIN01002M00.getIncomeTotal('bsopPlAmt'));
    $("#IncomeTotal_FAS03020301").html(FIN01002M00.getIncomeTotal('FAS03020301'));
    $("#IncomeTotal_FAS03020401").html(FIN01002M00.getIncomeTotal('FAS03020401'));
    $("#IncomeTotal_crtxSbbfNtprAmt").html(FIN01002M00.getIncomeTotal('crtxSbbfNtprAmt'));
    $("#IncomeTotal_FAS03020501").html(FIN01002M00.getIncomeTotal('FAS03020501'));
    $("#IncomeTotal_crtrNtPlAmt").html(FIN01002M00.getIncomeTotal('crtrNtPlAmt'));

    $("#CostTotal_FAS03030101").html(FIN01002M00.getCostTotal('FAS03030101'));
    $("#CostTotal_FAS0303010101").html(FIN01002M00.getCostTotal('FAS0303010101'));
    $("#CostTotal_FAS0303010102").html(FIN01002M00.getCostTotal('FAS0303010102'));
    $("#CostTotal_FAS03030201").html(FIN01002M00.getCostTotal('FAS03030201'));
    $("#CostTotal_FAS0303030101").html(FIN01002M00.getCostTotal('FAS0303030101'));
    $("#CostTotal_FAS0303030102").html(FIN01002M00.getCostTotal('FAS0303030102'));
    $("#CostTotal_FAS0303030103").html(FIN01002M00.getCostTotal('FAS0303030103'));
    $("#CostTotal_FAS0303030104").html(FIN01002M00.getCostTotal('FAS0303030104'));

    $("#FAS03040101s").html(FIN01002M00.finInputList01(FAS03040101s,'FAS03040101s'));
    $("#FAS03040201s").html(FIN01002M00.finInputList01(FAS03040201s,'FAS03040201s'));
    $("#FAS03040301s").html(FIN01002M00.finInputList02(FAS03040301s,'FAS03040301s'));
    $("#FAS03040401s").html(FIN01002M00.finInputList03(FAS03040401s,'FAS03040401s'));
    $("#FAS03040501s").html(FIN01002M00.finInputList01(FAS03040501s,'FAS03040501s'));
    $("#FAS03040601s").html(FIN01002M00.finInputList01(FAS03040601s,'FAS03040601s'));

    $("#AddValueTotal_FAS030401").html(FIN01002M00.getAddValueTotal('FAS030401'));
    $("#AddValueTotal_FAS030402").html(FIN01002M00.getAddValueTotal('FAS030402'));
    $("#AddValueTotal_FAS030403").html(FIN01002M00.getAddValueTotal('FAS030403'));
    $("#AddValueTotal_FAS030404").html(FIN01002M00.getAddValueTotal('FAS030404'));
    $("#AddValueTotal_FAS030405").html(FIN01002M00.getAddValueTotal('FAS030405'));
    $("#AddValueTotal_FAS030406").html(FIN01002M00.getAddValueTotal('FAS030406'));

    $("input").unbind("keyup");

    $("input").keyup(function() {
        
        setTimeout(FIN01002M00.onKeyUp,1000);
    });


};

FIN01002M00Component.prototype.onKeyUp = function() {
    FIN01002M00.onSetValue();
    FIN01002M00.onAddView();
};

FIN01002M00Component.prototype.onSetValue = function() {
...
FIN01002M00Component.prototype.finInputList = function(resArr) {
...
FIN01002M00Component.prototype.finInputList01 = function(resArr, accd) {
    ...
    for (var i = 0; i < resArr.length; i++) {
        ...
        html += '<label class="col-lg-4 control-label">' + resArr[i].finSmdcdNm + '</label>';
        html += '<div class="col-lg-6">';
        html += '<input type="number" min="0" max="9999999999999" size="13" class="form-control" value="'+ FIN01002M00.getAddValue01(accd, i) +'" name="' + resArr[i].finMdvcd + '" id="'+ resArr[i].finSmdcd +'"placeholder="0" lang="nb" readonly>';
        html += '</div>';
        html += '</div>';
    }
...
FIN01002M00Component.prototype.finInputList02 = function(resArr, accd) {
...
FIN01002M00Component.prototype.finInputList03 = function(resArr, accd) {
...
FIN01002M00Component.prototype.saveArr = function(sourceArr) {
...
FIN01002M00Component.prototype.onSave = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FIN01002M00.saveArr(FAS03010101s);
                FIN01002M00.saveArr(FAS03010102s);  //재고자산
                FIN01002M00.saveArr(FAS03010201s);  //투자자산
                FIN01002M00.saveArr(FAS03010202s);  //유형자산
                FIN01002M00.saveArr(FAS03010203s);  //무형자산
                FIN01002M00.saveArr(FAS03010204s);  //기타비유동자산
                FIN01002M00.saveArr(FAS03010301s);  //유동부채                
                FIN01002M00.saveArr(FAS03010401s);  //비유동부채
                FIN01002M00.saveArr(FAS03010501s);  //자본

                FIN01002M00.saveArr(FAS03020101s);  //매출
                FIN01002M00.saveArr(FAS03020201s);  //판매관리비
                FIN01002M00.saveArr(FAS03020301s);  //영업외수익
                FIN01002M00.saveArr(FAS03020401s);  //영업외비용
                FIN01002M00.saveArr(FAS03020501s);  //법인세     

                FIN01002M00.saveArr(FAS03030101s);  //당기총제조비용
                FIN01002M00.saveArr(FAS03030201s);  //경비
                FIN01002M00.saveArr(FAS03030301s);  //기타

                FIN01002M00.saveArr(FAS03040101s);  //법인세차감전순이익
                FIN01002M00.saveArr(FAS03040201s);  //인건비
                FIN01002M00.saveArr(FAS03040301s);  //금융비용
                FIN01002M00.saveArr(FAS03040401s);  //임차료
                FIN01002M00.saveArr(FAS03040501s);  //조세공과
                FIN01002M00.saveArr(FAS03040601s);  //감가상각비

                FIN01002M00.onAllRgsn();
...
FIN01002M00Component.prototype.saveFAS0304 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FIN01002M00.saveArr(FAS03040101s);  
                FIN01002M00.saveArr(FAS03040201s);  
                FIN01002M00.saveArr(FAS03040301s);  
                FIN01002M00.saveArr(FAS03040401s);  
                FIN01002M00.saveArr(FAS03040501s);  
                FIN01002M00.saveArr(FAS03040601s);  
...
FIN01002M00Component.prototype.initFAS0304 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FAS03040101s = FIN01002M00.initArr(FAS03040101s);  
                FAS03040201s = FIN01002M00.initArr(FAS03040201s);  
                FAS03040301s = FIN01002M00.initArr(FAS03040301s);  
                FAS03040401s = FIN01002M00.initArr(FAS03040401s);  
                FAS03040501s = FIN01002M00.initArr(FAS03040501s);  
                FAS03040601s = FIN01002M00.initArr(FAS03040601s); 

                setTimeout(FIN01002M00.initView, 2000);
...
FIN01002M00Component.prototype.initFAS0303 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FAS03030101s = FIN01002M00.initArr(FAS03030101s);  //당기총제조비용
                FAS03030201s = FIN01002M00.initArr(FAS03030201s);  //경비
                FAS03030301s = FIN01002M00.initArr(FAS03030301s);  //기타
...
FIN01002M00Component.prototype.saveFAS0303 = function() {
...
FIN01002M00Component.prototype.initFAS0302 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FAS03020101s = FIN01002M00.initArr(FAS03020101s);  //매출
                FAS03020201s = FIN01002M00.initArr(FAS03020201s);  //판매관리비
                FAS03020301s = FIN01002M00.initArr(FAS03020301s);  //영업외수익
                FAS03020401s = FIN01002M00.initArr(FAS03020401s);  //영업외비용
                FAS03020501s = FIN01002M00.initArr(FAS03020501s);  //법인세
...
FIN01002M00Component.prototype.saveFAS0302 = function() {
...
FIN01002M00Component.prototype.initFAS0301 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                var callFinArr = [];
                FAS03010101s = FIN01002M00.initArr(FAS03010101s);
                FAS03010102s = FIN01002M00.initArr(FAS03010102s);  //재고자산
                FAS03010201s = FIN01002M00.initArr(FAS03010201s);  //투자자산
                FAS03010202s = FIN01002M00.initArr(FAS03010202s);  //유형자산
                FAS03010203s = FIN01002M00.initArr(FAS03010203s);  //무형자산
                FAS03010204s = FIN01002M00.initArr(FAS03010204s);  //기타비유동자산
                FAS03010301s = FIN01002M00.initArr(FAS03010301s);  //유동부채                
                FAS03010401s = FIN01002M00.initArr(FAS03010401s);  //비유동부채
                FAS03010501s = FIN01002M00.initArr(FAS03010501s);  //자본
...
FIN01002M00Component.prototype.initView = function() {
    FIN01002M00.setAddValue();
    FIN01002M00.onView();
};

FIN01002M00Component.prototype.saveFAS0301 = function() {
...
FIN01002M00Component.prototype.onRgsn = function() {

    overlay.show();

    FIN01002M00.onSetValue();

    finService.saveEntpFinInfo(finfnaminfos, FIN01002M00.callback);

};

FIN01002M00Component.prototype.onAllRgsn = function() {

    overlay.show();

    FIN01002M00.onSetValue();

    finService.saveEntpFinInfo(finfnaminfos, FIN01002M00.allCallback);
...
FIN01002M00Component.prototype.allCallback = function(data) {
...
FIN01002M00Component.prototype.initArr = function(arr) {
    var initFin = [];
    var initparam = {};
    for (var i = 0; i < arr.length; i++) {
