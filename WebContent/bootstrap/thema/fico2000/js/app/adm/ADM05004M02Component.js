var ADM05004M02 = new ADM05004M02Component();

var boardCode = 'FAS900204'; //자주묻는질문

var uploadObj = {};

var boardService = new BoardMngService(true);

function ADM05004M02Component() {

};

ADM05004M02Component.prototype.ngOnInit = function () {
    ...
    ADM05004M02.onSearch();
};

ADM05004M02Component.prototype.onSearch = function () {
    var code = $("#code").val();
    var mainNo = $("#mainNo").val();
    overlay.show();
    var res = boardService.getBoardMngInfo(code, mainNo, ADM05004M02.boardCallback);
};

ADM05004M02Component.prototype.onSave = function () {
    ...
    var res = boardService.updBoardMng(selectedBoard, ADM05004M02.callback);

};

ADM05004M02Component.prototype.onDel = function () {
    ...
    var res = boardService.delBoardMng(selectedBoard, ADM05004M02.callback);

}

ADM05004M02Component.prototype.onGoList = function () {
    toMove('ADM05004M00');
};

ADM05004M02Component.prototype.callback = function(data) {
...
ADM05004M02Component.prototype.boardCallback = function(data) {
