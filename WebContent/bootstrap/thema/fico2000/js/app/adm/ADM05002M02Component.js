var ADM05002M02 = new ADM05002M02Component();
...
function ADM05002M02Component() {

};

ADM05002M02Component.prototype.ngOnInit = function () {
    ...
    ADM05002M02.onSearch();
};

ADM05002M02Component.prototype.onSearch = function () {
    var code = $("#code").val();
    var mainNo = $("#mainNo").val();
    overlay.show();
    var res = boardService.getBoardMngInfo(code, mainNo, ADM05002M02.boardCallback);
};

ADM05002M02Component.prototype.onSave = function () {
    ...
    var res = boardService.updBoardMng(selectedBoard, ADM05002M02.callback);

};

ADM05002M02Component.prototype.onDel = function () {
    ...
    var res = boardService.delBoardMng(selectedBoard, ADM05002M02.callback);

}

ADM05002M02Component.prototype.onGoList = function () {
    toMove('ADM05002M00');
};

ADM05002M02Component.prototype.callback = function(data) {
...
ADM05002M02Component.prototype.boardCallback = function(data) {
