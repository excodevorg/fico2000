var ADM05003M01 = new ADM05003M01Component();
...
function ADM05003M01Component() {

};

ADM05003M01Component.prototype.ngOnInit = function () {
...
ADM05003M01Component.prototype.onSave = function () {
    ...
    var res = boardService.saveBoardMng(selectedBoard, ADM05003M01.callback);

};

ADM05003M01Component.prototype.onGoList = function () {
    toMove('ADM05003M00');
};

ADM05003M01Component.prototype.onInit = function () {
...
ADM05003M01Component.prototype.callback = function(data) {
