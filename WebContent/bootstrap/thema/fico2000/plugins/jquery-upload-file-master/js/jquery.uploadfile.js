...
(function ($) {
	...
	this.enqueueFile = function(file){
        ...
        this.createProgress = function (filename,filepath,filesize, data) {
            ...
            if(s.showDownload) {
                ...
                pd.download.click(function () {
                    if (data) {
                        console.log('downloadCallback >>> ', data);
                        if(s.downloadCallback) s.downloadCallback.call(obj, data, pd);
                    } else {
