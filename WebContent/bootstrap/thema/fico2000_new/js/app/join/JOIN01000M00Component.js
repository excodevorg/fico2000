...
var JOIN01000M00 = new JOIN01000M00Component();
var duplicateShield = false // 중복방지 

var userService = new UserService(false);
var boardService = new BoardMngService(true);

function JOIN01000M00Component() {

};

JOIN01000M00Component.prototype.afterSelect = function(data) {
...
JOIN01000M00Component.prototype.ngOnInit = function () {

	var params = {
    };

    var data = joinService.selectApcProduct(params, JOIN01000M00.afterSelect);
	
};

JOIN01000M00Component.prototype.joinCheckStatus = function(productId) {

	var params = {
            productId: productId
    };

    var data = joinService.joinStatusCheck(params, JOIN01000M00.callback);
...
$(document).ready(function() {
    ...
    $('#basicUseBtn').click(function(){
    	...
    	JOIN01000M00.joinCheckStatus('0001');
    ...
    $('#premiumUseBtn').click(function(){
    	...
    	JOIN01000M00.joinCheckStatus('0002');
    ...
    JOIN01000M00.ngOnInit();

});

JOIN01000M00Component.prototype.callback = function(data) {
