...
var JOIN03002M00 = new JOIN03002M00Component();
...
function JOIN03002M00Component() {

};

JOIN03002M00Component.prototype.afterSelect = function(data) {
...
JOIN03002M00Component.prototype.ngOnInit = function () {
    ...
    var data = joinService.selectSettlement(params, JOIN03002M00.afterSelect);
};
