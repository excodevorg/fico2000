var ADM05001M02 = new ADM05001M02Component();

var boardCode = 'FAS900201'; //공지사항

var uploadObj = {};

var boardService = new BoardMngService(true);

function ADM05001M02Component() {

};

ADM05001M02Component.prototype.ngOnInit = function () {
    ...
    ADM05001M02.onSearch();
};

ADM05001M02Component.prototype.onSearch = function () {
    var code = $("#code").val();
    var mainNo = $("#mainNo").val();
    overlay.show();
    var res = boardService.getBoardMngInfo(code, mainNo, ADM05001M02.boardCallback);
};

ADM05001M02Component.prototype.onSave = function () {
    ...
    var res = boardService.updBoardMng(selectedBoard, ADM05001M02.callback);

};

ADM05001M02Component.prototype.onDel = function () {
    ...
    var res = boardService.delBoardMng(selectedBoard, ADM05001M02.callback);

}

ADM05001M02Component.prototype.onGoList = function () {
    toMove('ADM05001M00');
};

ADM05001M02Component.prototype.callback = function(data) {
...
ADM05001M02Component.prototype.boardCallback = function(data) {
