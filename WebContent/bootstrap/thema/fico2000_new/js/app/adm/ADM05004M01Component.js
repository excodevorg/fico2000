var ADM05004M01 = new ADM05004M01Component();

var boardCode = 'FAS900204'; //자주묻는 질문

var uploadObj = {};

var boardService = new BoardMngService(true);

function ADM05004M01Component() {

};

ADM05004M01Component.prototype.ngOnInit = function () {
...
ADM05004M01Component.prototype.onSave = function () {
    ...
    var res = boardService.saveBoardMng(selectedBoard, ADM05004M01.callback);

};

ADM05004M01Component.prototype.onGoList = function () {
    toMove('ADM05004M00');
};

ADM05004M01Component.prototype.onInit = function () {
...
ADM05004M01Component.prototype.callback = function(data) {
