var ADM05005M02 = new ADM05005M02Component();
...
function ADM05005M02Component() {

};

ADM05005M02Component.prototype.ngOnInit = function () {
    ...
    ADM05005M02.onSearch();
};

ADM05005M02Component.prototype.onSearch = function () {
    var code = $("#code").val();
    var mainNo = $("#mainNo").val();
    overlay.show();
    var res = boardService.getBoardMngInfo(code, mainNo, ADM05005M02.boardCallback);
};

ADM05005M02Component.prototype.onSave = function () {
    ...
    var res = boardService.updBoardMng(selectedBoard, ADM05005M02.callback);

};

ADM05005M02Component.prototype.onDel = function () {
    ...
    var res = boardService.delBoardMng(selectedBoard, ADM05005M02.callback);

}

ADM05005M02Component.prototype.onGoList = function () {
    toMove('ADM05005M00');
};

ADM05005M02Component.prototype.onReplyWrite = function () {

    var params = '"code='+boardCode+'*relNo='+$("#mainNo").val()+'"';
    toMove('ADM05005M03',params);

};

ADM05005M02Component.prototype.callback = function(data) {
...
ADM05005M02Component.prototype.boardCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success==true) { 
            ...
            $("#relNo").val(res.data.board.relNo);
            $("#hpno").val(res.data.board.hpno);

            if ($("#mainNo").val() != $("#relNo").val()) {
