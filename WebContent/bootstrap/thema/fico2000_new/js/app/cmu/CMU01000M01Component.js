var CMU01000M01 = new CMU01000M01Component();

var boardCode = 'FAS900204';

var boardMngService = new BoardMngService(true);

function CMU01000M01Component() {

};

CMU01000M01Component.prototype.ngOnInit = function () {
    CMU01000M01.onSearch();
};

CMU01000M01Component.prototype.onSearch = function () {
    ...
    var res = boardMngService.getBoardInfo(code, mainNo, CMU01000M01.callback);

};

CMU01000M01Component.prototype.callback = function (data) {
