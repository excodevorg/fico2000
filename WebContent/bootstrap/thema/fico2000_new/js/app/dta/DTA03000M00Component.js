var DTA03000M00 = new DTA03000M00Component();

var boardCode = 'FAS900201';

var boardMngService = new BoardMngService(true);

function DTA03000M00Component() {

};

DTA03000M00Component.prototype.ngOnInit = function () {
    $("#grid-list").bootgrid();
    DTA03000M00.onSearch();
};

DTA03000M00Component.prototype.onSearch = function () {
