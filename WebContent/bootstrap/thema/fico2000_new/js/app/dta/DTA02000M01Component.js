var DTA02000M01 = new DTA02000M01Component();

var boardCode = 'FAS900202';

var boardMngService = new BoardMngService(true);

function DTA02000M01Component() {

};

DTA02000M01Component.prototype.ngOnInit = function () {
    DTA02000M01.onSearch();
};

DTA02000M01Component.prototype.onSearch = function () {
    ...
    var res = boardMngService.getBoardInfo(code, mainNo, DTA02000M01.callback);

};

DTA02000M01Component.prototype.callback = function (data) {
