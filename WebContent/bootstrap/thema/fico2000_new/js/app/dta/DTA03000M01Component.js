var DTA03000M01 = new DTA03000M01Component();

var boardCode = 'FAS900201';

var boardMngService = new BoardMngService(true);

function DTA03000M01Component() {

};

DTA03000M01Component.prototype.ngOnInit = function () {
    DTA03000M01.onSearch();
};

DTA03000M01Component.prototype.onSearch = function () {
    ...
    var res = boardMngService.getBoardInfo(code, mainNo, DTA03000M01.callback);

};

DTA03000M01Component.prototype.callback = function (data) {
