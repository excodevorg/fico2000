var FIN03231M00 = new FIN03231M00Component();
...
function FIN03231M00Component() {

};

FIN03231M00Component.prototype.ngOnInit = function () {
...
FIN03231M00Component.prototype.onSearch = function () {
    FIN03231M00.initQsrtSave();
};

FIN03231M00Component.prototype.onResult = function() {
    console.log('onResult Start');
    overlay.show();
    finService.getEstmIs(finAplyCom.alyid, finAplyCom.stacYy, qsrtInfo, FIN03231M00.resultCallback);
};

FIN03231M00Component.prototype.resultCallback = function(result) {
...
FIN03231M00Component.prototype.ResultView = function() {
    ...
    cashFlowResult +='                                <div class="pad-all text-center">                                                                ';
    cashFlowResult +='                                    <span class="text-3x text-thin">'+FIN03231M00.onNumberWithCommas(cashFlowResultInfo.mnbsAcvtRslt)+'</span>   ';
    ...
    cashFlowResult +='                                <div class="pad-all text-center">                                                                ';
    cashFlowResult +='                                    <span class="text-3x text-thin">'+FIN03231M00.onNumberWithCommas(cashFlowResultInfo.lastInsfAmt)+'</span>    ';
    ...
    cashFlowResult +='                                <div class="pad-all text-center">                                                                ';
    cashFlowResult +='                                    <span class="text-3x text-thin">'+FIN03231M00.onNumberWithCommas(cashFlowResultInfo.lastSmexAmt)+'</span>    ';
...
FIN03231M00Component.prototype.initQsrtSave = function() {
    overlay.show();
    console.log("initQsrtSave >>> start >>>>" , finAplyCom);
    var res = finService.getQsrtMngRsltInfoList(finAplyCom.alyid, finAplyCom.stacYy, FIN03231M00.qsrtMngRsltCallback);
};

FIN03231M00Component.prototype.qsrtMngRsltCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            FIN03231M00.onQstrInfo(res);
            FIN03231M00.onResult();
            overlay.hide();
...
FIN03231M00Component.prototype.onQstrInfo = function(res) {
...
FIN03231M00Component.prototype.onNumberWithCommas = function(totalAmt) {
