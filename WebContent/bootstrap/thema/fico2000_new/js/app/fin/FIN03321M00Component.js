var FIN03321M00 = new FIN03321M00Component();
...
function FIN03321M00Component() {

};

FIN03321M00Component.prototype.ngOnInit = function () {
...
FIN03321M00Component.prototype.onSearch = function () {
    FIN03321M00.initQsrtSave();
};

FIN03321M00Component.prototype.initQsrtSave = function() {
    console.log("initQsrtSave >>> start >>>>" , finAplyCom);
	
	overlay.show();

    //현금흐름 설문지......
    finService.getQsrtFinRsltInfoList(finAplyCom.alyid, finAplyCom.stacYy, FIN03321M00.QsrtFinRsltCallback);
};
...
//경영투자 분석 설문지
FIN03321M00Component.prototype.onQstrInfo = function(res) {
...
FIN03321M00Component.prototype.onFinEstmls = function() {

    console.log("<<<<<< onCashIncomeList() start >>>>> ")
    
    finService.getFinEstmls(finAplyCom.alyid, finAplyCom.stacYy, qsrtInfo, FIN03321M00.finEstmlsCallback);

};

FIN03321M00Component.prototype.finEstmlsCallback = function(result) {
...
FIN03321M00Component.prototype.onFinEstmlsView = function() {
...
fincashFlowResultTable += '                        <div class="pad-all text-center">                                                                                              ';
fincashFlowResultTable += '                            <span class="text-3x text-thin">'+FIN03321M00.onNumberWithCommas(fincashFlowResult.mnbsAcvtRslt)+'</span>                              ';
fincashFlowResultTable += '                            <p>연간 경영활동 결과 '+FIN03321M00.onNumberWithCommas(fincashFlowResult.mnbsAcvtRslt)+' 천원 '+fincashFlowResult.mnbsAcvtRsltCon+'</p>         ';
fincashFlowResultTable += '                        </div>                                                                                                                         ';
fincashFlowResultTable += '                    </div>                                                                                                                             ';
fincashFlowResultTable += '                </div>                                                                                                                                 ';
fincashFlowResultTable += '                <div class="col-lg-3">                                                                                                                 ';
...
fincashFlowResultTable += '                        <div class="pad-all text-center">                                                                                              ';
fincashFlowResultTable += '                            <span class="text-3x text-thin">'+FIN03321M00.onNumberWithCommas(fincashFlowResult.lastInsfAmt)+'</span>                               ';
...
fincashFlowResultTable += '                        <div class="pad-all text-center">                                                                                              ';
fincashFlowResultTable += '                            <span class="text-3x text-thin">'+FIN03321M00.onNumberWithCommas(fincashFlowResult.lastSmexAmt)+'</span>                               ';
...
FIN03321M00Component.prototype.QsrtFinRsltCallback = function(result) {
...
FIN03321M00Component.prototype.getQsrtNo = function(qsrtNo) {
...
FIN03321M00Component.prototype.onNumberWithCommas = function(totalAmt) {
    return numberWithCommas(totalAmt);
};
