...
var FIN03102M00 = new FIN03102M00Component();
...
function FIN03102M00Component() {

};

FIN03102M00Component.prototype.ngOnInit = function () {
...
FIN03102M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03102M00.finAnalyCallback);


};


FIN03102M00Component.prototype.finAnalyCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            alyDataSet.forEach(function(selectedRaw, index) {
                ...
                FIN03102M00.onBalance(selectedRaw);
                FIN03102M00.onIncome(selectedRaw);
                FIN03102M00.onCost(selectedRaw);
                FIN03102M00.onAddedValue(selectedRaw);

                console.log('-------- ending -------');

                bsTable += FIN03102M00.onBsTableView(index);

                detTable += FIN03102M00.onDebtTableView(index);

                incomeTable += FIN03102M00.onIncomeTableView(index);
            ...
            $("#tb_income_bon").html(incomeTable).trigger("create");

            $("#roeTable").html(FIN03102M00.onRoeTableView()).trigger("create");
...
FIN03102M00Component.prototype.onBalance = function(res) {
...
FIN03102M00Component.prototype.onIncome = function(res) {
...
FIN03102M00Component.prototype.onCost = function(res) {
...
FIN03102M00Component.prototype.onAddedValue = function(res) {
    ...
    FIN03102M00.setAddValue();

};

FIN03102M00Component.prototype.setAddValue = function() {
...
FIN03102M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03102M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03102M00Component.prototype.getBsTotal = function(accd) {
...
FIN03102M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03102M00Component.prototype.getCostTotal = function(accd) {
...
FIN03102M00Component.prototype.onBsTableView = function(idx) {
    ...
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(FIN03102M00.getBsTotal('FAS030105'))+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(FAS03010501s[i].finAmt)+'</td>';i++;
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(FAS03010501s[i].finAmt)+'</td>';i++;
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(FAS03010501s[i].finAmt)+'</td>';i++;
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(FAS03010501s[i].finAmt)+'</td>';i++;
    bsTable += '</tr>';
...
FIN03102M00Component.prototype.onDebtTableView = function(idx) {
    ...
    bsTable += '<tr>';
    bsTable += '<td >'+finAplyCom.stacYys[idx]+'</td>';
    var totalDebt = Number(FIN03102M00.getBsTotal('FAS030103')) + Number(FIN03102M00.getBsTotal('FAS030104'));
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(totalDebt)+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(FIN03102M00.getBsTotal('FAS030103'))+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(FIN03102M00.getBsTotal('FAS030104'))+'</td>';
    var totalBon = FIN03102M00.getBsTotal('FAS030101') + FIN03102M00.getBsTotal('FAS030102');
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(totalBon)+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(FIN03102M00.getBsTotal('FAS030101'))+'</td>';
    bsTable += '<td class="text-right" >'+FIN03102M00.onNumberWithCommas(FIN03102M00.getBsTotal('FAS030102'))+'</td>';
...
FIN03102M00Component.prototype.onRoeTableView = function() {
    var bsTable = "";
    ...
    var start = Number(roe_dataset.length) - 1;

   for (var i =start; i >= 0; i--) {
        bsTable += '<td class="text-center">'+roe_dataset[i].key+'</td>';
    }
    bsTable += '</tr>';
    bsTable += '</thead>';
    bsTable += '<tbody>';
    bsTable += '<tr class="text-bold text-lg">';
    bsTable += '<td>자기자본 수익율 (ROE)</td>';

    for (var i =start; i >= 0; i--) {
    bsTable += '<td class="text-right">'+roe_dataset[i].value+' %</td>';
    }
...
FIN03102M00Component.prototype.onPlot = function() {
   ...
   for (var i =start; i >= 0; i--) {
    day_data.push({
        "elapsed":roe_dataset[i].key,
        "value":Number(roe_dataset[i].value)
        });
    }
...
FIN03102M00Component.prototype.onIncomeTableView = function(idx) {
	
    var num = Number(idx);
    var size = num + 1;
    var modValue = 0;

    var totalDebt = Number(FIN03102M00.getBsTotal('FAS030103')) + Number(FIN03102M00.getBsTotal('FAS030104')); //총부채
    var totalBon = FIN03102M00.getBsTotal('FAS030101') + FIN03102M00.getBsTotal('FAS030102'); //총자산
    var totalBs = FIN03102M00.getBsTotal('FAS030105'); //총자본
    
    FIN03102M00.getIncomeTotal('FAS0302010101');
    FIN03102M00.getIncomeTotal('FAS0302010102');
    FIN03102M00.getIncomeTotal('amslTtalPlAmt');
    FIN03102M00.getIncomeTotal('FAS03020201');
    FIN03102M00.getIncomeTotal('bsopPlAmt');
    FIN03102M00.getIncomeTotal('FAS03020301');
    FIN03102M00.getIncomeTotal('FAS03020401');
    FIN03102M00.getIncomeTotal('crtxSbbfNtprAmt');
    FIN03102M00.getIncomeTotal('FAS03020501');
    FIN03102M00.getIncomeTotal('crtrNtPlAmt');
    ...
    if (totalBon != 0 && totalBon != undefined && totalBon != null ) {
        ...
        if (incomeRate1 != 0 && incomeRate1 != undefined && incomeRate1 != null ) {
            roeRate = incomeRate / incomeRate1;
            roeRate = roeRate * 100;
            roeRate = roeRate.toFixed(2);
        }
    } 
    ...
    roe_dataset.push(params);

    var bsTable = "";

    bsTable += '<tr>';
    bsTable += '<td>'+finAplyCom.stacYys[idx]+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(totalBs)+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(totalDebt)+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(totalBon)+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(crtrNtPlAmt)+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(incomeRate)+'</td>';
    bsTable += '<td class="text-right">'+FIN03102M00.onNumberWithCommas(incomeRate1)+'</td>';
    bsTable += '</tr>';
...
FIN03102M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03102M00Component.prototype.onFinResult = function () {
