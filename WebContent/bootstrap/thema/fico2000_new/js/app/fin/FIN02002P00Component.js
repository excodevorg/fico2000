...
var FIN02002P00 = new FIN02002P00Component();
...
function FIN02002P00Component() {

};


FIN02002P00Component.prototype.ngOnInit = function () {
    overlay.show();    

    console.log('ngOnInit >>> ', parent.getFinAplyCom());

    finAplyCom = parent.getFinAplyCom();

    console.log('finAplyCom.entpName >>> ', finAplyCom.entpName);

    $("span[name='entpName']").each(function (idx) {
        $("span[name='entpName']").eq(idx).html('');
    ...
    $("select[name='stacYyInfo']").each(function (idx) {
        ...
        $("select[name='stacYyInfo']").eq(idx).html(finAplyCom.rightStacYyArr.join(''));
    });

    finAplyCom.stacYy = $("#stacYyInfos option:selected").val();
    
    $("span[name='amtUnitNm']").each(function (idx) {
        $("span[name='amtUnitNm']").eq(idx).html(finAplyCom.amtUnitNm);
    });

    finService.getAnalysisFinDtTypeMap(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYy, FIN02002P00.finCallback);
    ...
    $("#initFAS0301").click(function() {
        FIN02002P00.initFAS0301();
    });

    $("#saveFAS0301").click(function() {
        FIN02002P00.saveFAS0301();
    });

    $("#initFAS0302").click(function() {
        FIN02002P00.initFAS0302();
    });

    $("#saveFAS0302").click(function() {
        FIN02002P00.saveFAS0302();
    });

    $("#initFAS0303").click(function() {
        FIN02002P00.initFAS0303();
    });

    $("#saveFAS0303").click(function() {
        FIN02002P00.saveFAS0303();
    });

    $("#initFAS0304").click(function() {
        FIN02002P00.initFAS0304();
    });

    $("#saveFAS0304").click(function() {
        FIN02002P00.saveFAS0304();
    });
...
FIN02002P00Component.prototype.finCallback = function(data) {
    
    if (data != null) {
        var res = JSON.parse(data);

        console.log('finCallback1111 >>> ', res.success);   

        if (res.success) {
            FIN02002P00.finInit();
            console.log('onBalance');
            FIN02002P00.onBalance(res);
            console.log('onIncome');
            FIN02002P00.onIncome(res);
            console.log('onCost');
            FIN02002P00.onCost(res);
            console.log('onAddedValue');
            FIN02002P00.onAddedValue(res);
            console.log('onView');
            FIN02002P00.onView();
...
FIN02002P00Component.prototype.finInit = function() {
    ...
    FAS03020501s = []; //법인세
    ///////////////////////////////////////////
    FAS03030101s = []; //당기총제조비용
    FAS03030201s = []; //경비
    FAS03030301s = []; //기타
    ///////////////////////////////////////////
    FAS03040101s = []; //법인세차감전순이익
    FAS03040201s = []; //인건비
    FAS03040301s = []; //금융비용  
    FAS03040401s = []; //임차료
    FAS03040501s = []; //조세공과 
    ...
    astTtsmAmt = 0;//자산총금액
    lbltCptsAmt = 0; //부채및자본총금액
    amslAmt = 0; //매출액
    ampmAmt = 0; //매출원가
    amslTtalPlAmt = 0; //매출총손익
    slexExAmt = 0; //판매비와관리비
    bsopPlAmt = 0; //영업손익금액
    nnoeAmt = 0; //영업외수익금액
    nnopExpAmt = 0; //영업외비용금액
    crtxSbbfNtprAmt = 0; //법인세차감전순이익금액
    crtxExpAmt = 0; //법인세비용
    crtrNtPlAmt = 0; //당기순손익금액
    crtrTtalMnfcExpAmt = 0; //당기총제조비용
    mtcsAmt = 0; //재료비
    lbexAmt = 0; //노무비금액
    exnsAmt = 0; //경비금액
    basGdipAmt = 0; //기초제공품원가
    edprGdipInvmAmt = 0; //기말재공품원가
    tgasAmt = 0;//유형자산(타계정)대체액
    crtrPrdtPdcsAmt = 0; //당기제품제조원가

};

FIN02002P00Component.prototype.onBalance = function(res) {
...
FIN02002P00Component.prototype.onIncome = function(res) {
...
FIN02002P00Component.prototype.onCost = function(res) {
...
FIN02002P00Component.prototype.onAddedValue = function(res) {
        ...
        FIN02002P00.setAddValue();

    };


FIN02002P00Component.prototype.setAddValue = function() { 
...
FIN02002P00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN02002P00Component.prototype.getAddValueTotal = function(accd) {
...
FIN02002P00Component.prototype.getBsTotal = function(accd) {
...
FIN02002P00Component.prototype.getIncomeTotal = function(accd) {
...
FIN02002P00Component.prototype.getCostTotal = function(accd) {
...
FIN02002P00Component.prototype.getCostTotal01 = function(accd) {
...
FIN02002P00Component.prototype.onView = function() {

    $("#FAS03010101s").html("").trigger('create');
    $("#FAS03010102s").html("").trigger('create');
    $("#FAS03010201s").html("").trigger('create');
    $("#FAS03010202s").html("").trigger('create');
    $("#FAS03010203s").html("").trigger('create');
    $("#FAS03010204s").html("").trigger('create');
    $("#FAS03010301s").html("").trigger('create');
    $("#FAS03010401s").html("").trigger('create');
    $("#FAS03010501s").html("").trigger('create');
    $("#FAS03020101s").html("").trigger('create');
    $("#FAS03020201s").html("").trigger('create');
    $("#FAS03020301s").html("").trigger('create');
    $("#FAS03020401s").html("").trigger('create');
    $("#FAS03020501s").html("").trigger('create');

    $("#FAS03030101s").html("").trigger('create');
    $("#FAS03030201s").html("").trigger('create');
    $("#FAS03030301s").html("").trigger('create');

    console.log('before #FAS03010101s >>' , $("#FAS03010101s").html());

    $("#FAS03010101s").html(FIN02002P00.finInputList(FAS03010101s));


    console.log('after #FAS03010101s >>' , $("#FAS03010101s").html());
    $("#FAS03010102s").html(FIN02002P00.finInputList(FAS03010102s));
    $("#FAS03010201s").html(FIN02002P00.finInputList(FAS03010201s));
    $("#FAS03010202s").html(FIN02002P00.finInputList(FAS03010202s));
    $("#FAS03010203s").html(FIN02002P00.finInputList(FAS03010203s));
    $("#FAS03010204s").html(FIN02002P00.finInputList(FAS03010204s));
    $("#FAS03010301s").html(FIN02002P00.finInputList(FAS03010301s));
    $("#FAS03010401s").html(FIN02002P00.finInputList(FAS03010401s));
    $("#FAS03010501s").html(FIN02002P00.finInputList(FAS03010501s));

    $("#FAS03020101s").html(FIN02002P00.finInputList(FAS03020101s));
    $("#FAS03020201s").html(FIN02002P00.finInputList(FAS03020201s));
    $("#FAS03020301s").html(FIN02002P00.finInputList(FAS03020301s));
    $("#FAS03020401s").html(FIN02002P00.finInputList(FAS03020401s));
    $("#FAS03020501s").html(FIN02002P00.finInputList(FAS03020501s));

    $("#FAS03030101s").html(FIN02002P00.finInputList(FAS03030101s));
    $("#FAS03030201s").html(FIN02002P00.finInputList(FAS03030201s));
    $("#FAS03030301s").html(FIN02002P00.finInputList(FAS03030301s));

    FIN02002P00.onAddView();

};

FIN02002P00Component.prototype.onAddView = function() {
	
	console.log('onAddView Start');

    $("#BsTotal_FAS030101").html(FIN02002P00.getBsTotal('FAS030101'));
    $("#BsTotal_FAS030102").html(FIN02002P00.getBsTotal('FAS030102'));
    $("#BsTotal_FAS030101G").html(FIN02002P00.getBsTotal('FAS030101G'));
    $("#BsTotal_FAS030101T").html(FIN02002P00.getBsTotal('FAS030101T'));

    $("#BsTotal_FAS030103").html(FIN02002P00.getBsTotal('FAS030103'));
    $("#BsTotal_FAS030104").html(FIN02002P00.getBsTotal('FAS030104'));
    $("#BsTotal_FAS030105").html(FIN02002P00.getBsTotal('FAS030105'));
    $("#BsTotal_FAS030103T").html(FIN02002P00.getBsTotal('FAS030103T'));

    $("#IncomeTotal_FAS0302010101").html(FIN02002P00.getIncomeTotal('FAS0302010101'));
    $("#IncomeTotal_FAS0302010102").html(FIN02002P00.getIncomeTotal('FAS0302010102'));
    $("#IncomeTotal_amslTtalPlAmt").html(FIN02002P00.getIncomeTotal('amslTtalPlAmt'));
    $("#IncomeTotal_FAS03020201").html(FIN02002P00.getIncomeTotal('FAS03020201'));
    $("#IncomeTotal_bsopPlAmt").html(FIN02002P00.getIncomeTotal('bsopPlAmt'));
    $("#IncomeTotal_FAS03020301").html(FIN02002P00.getIncomeTotal('FAS03020301'));
    $("#IncomeTotal_FAS03020401").html(FIN02002P00.getIncomeTotal('FAS03020401'));
    $("#IncomeTotal_crtxSbbfNtprAmt").html(FIN02002P00.getIncomeTotal('crtxSbbfNtprAmt'));
    $("#IncomeTotal_FAS03020501").html(FIN02002P00.getIncomeTotal('FAS03020501'));
    $("#IncomeTotal_crtrNtPlAmt").html(FIN02002P00.getIncomeTotal('crtrNtPlAmt'));

    $("#CostTotal_FAS03030101").html(FIN02002P00.getCostTotal('FAS03030101'));
    $("#CostTotal_FAS0303010101").html(FIN02002P00.getCostTotal('FAS0303010101'));
    $("#CostTotal_FAS0303010102").html(FIN02002P00.getCostTotal('FAS0303010102'));
    $("#CostTotal_FAS03030201").html(FIN02002P00.getCostTotal('FAS03030201'));
    $("#CostTotal_FAS0303030101").html(FIN02002P00.getCostTotal('FAS0303030101'));
    $("#CostTotal_FAS0303030102").html(FIN02002P00.getCostTotal('FAS0303030102'));
    $("#CostTotal_FAS0303030103").html(FIN02002P00.getCostTotal('FAS0303030103'));
    $("#CostTotal_FAS0303030104").html(FIN02002P00.getCostTotal('FAS0303030104'));

    $("#FAS03040101s").html(FIN02002P00.finInputList01(FAS03040101s,'FAS03040101s'));
    $("#FAS03040201s").html(FIN02002P00.finInputList01(FAS03040201s,'FAS03040201s'));
    $("#FAS03040301s").html(FIN02002P00.finInputList02(FAS03040301s,'FAS03040301s'));
    $("#FAS03040401s").html(FIN02002P00.finInputList03(FAS03040401s,'FAS03040401s'));
    $("#FAS03040501s").html(FIN02002P00.finInputList01(FAS03040501s,'FAS03040501s'));
    $("#FAS03040601s").html(FIN02002P00.finInputList01(FAS03040601s,'FAS03040601s'));

    $("#AddValueTotal_FAS030401").html(FIN02002P00.getAddValueTotal('FAS030401'));
    $("#AddValueTotal_FAS030402").html(FIN02002P00.getAddValueTotal('FAS030402'));
    $("#AddValueTotal_FAS030403").html(FIN02002P00.getAddValueTotal('FAS030403'));
    $("#AddValueTotal_FAS030404").html(FIN02002P00.getAddValueTotal('FAS030404'));
    $("#AddValueTotal_FAS030405").html(FIN02002P00.getAddValueTotal('FAS030405'));
    $("#AddValueTotal_FAS030406").html(FIN02002P00.getAddValueTotal('FAS030406'));

console.log('FAS0304 >>> ', FIN02002P00.getAddValueTotal('FAS0304'));

    $("#AddValueTotal_FAS0304").html(FIN02002P00.getAddValueTotal('FAS0304'));

    $("input").unbind("keyup");

    $("input").keyup(function() {
        
        setTimeout(FIN02002P00.onKeyUp,1000);
    });


};

FIN02002P00Component.prototype.onKeyUp = function() {
    FIN02002P00.onSetValue();
    FIN02002P00.onAddView();
};

FIN02002P00Component.prototype.onSetValue = function() {
...
FIN02002P00Component.prototype.finInputList = function(resArr) {
    ...
    for (var i = 0; i < resArr.length; i++) {
        ...
        html += '<label class="col-lg-4 control-label" style="margin-left:20px;">' + resArr[i].finSmdcdNm + '</label>';
        html += '<div class="col-lg-6">';
        html += '<input type="number" min="0" max="9999999999999" size="13" class="form-control" value="'+ resArr[i].finAmt +'" name="' + resArr[i].finMdvcd + '" id="'+ resArr[i].finSmdcd +'" placeholder="0" lang="nb" style="width:95%;margin-left:20px;">';
        html += '</div>';
        html += '</div>';
    }
...
FIN02002P00Component.prototype.finInputList01 = function(resArr, accd) {
    ...
    for (var i = 0; i < resArr.length; i++) {
        ...
        html += '<label class="col-lg-4 control-label" style="margin-left:20px;">' + resArr[i].finSmdcdNm + '</label>';
        html += '<div class="col-lg-6">';
        html += '<input type="number" min="0" max="9999999999999" size="13" class="form-control" value="'+ FIN02002P00.getAddValue01(accd, i) +'" name="' + resArr[i].finMdvcd + '" id="'+ resArr[i].finSmdcd +'"placeholder="0" lang="nb" style="width:95%;margin-left:20px;" readonly >';
        html += '</div>';
        html += '</div>';
    }
...
FIN02002P00Component.prototype.finInputList02 = function(resArr, accd) {
    ...
    for (var i = 0; i < resArr.length; i++) {
        ...
        html += '<div class="col-lg-6">';
        if (i != 0 && i != 3 ) {
            html += '<input type="number" min="0" max="9999999999999" size="13" class="form-control" value="'+ resArr[i].finAmt +'" name="' + resArr[i].finMdvcd + '" id="'+ resArr[i].finSmdcd +'" placeholder="0" style="width:95%;margin-left:20px;" lang="nb">';
        } else {
            html += '<input type="number" min="0" max="9999999999999" size="13" class="form-control" value="'+ FIN02002P00.getAddValue01(accd, i) +'" name="' + resArr[i].finMdvcd + '" id="'+ resArr[i].finSmdcd +'" placeholder="0" style="width:95%;margin-left:20px;" lang="nb" readonly>';
        }
        html += '</div>';
        html += '</div>';
    }
...
FIN02002P00Component.prototype.finInputList03 = function(resArr, accd) {
...
FIN02002P00Component.prototype.saveArr = function(sourceArr) {

        sourceArr.forEach( function(selectedRow, index) {

               finfnaminfos.push({
                    alyid:finAplyCom.alyid,
                    userid:finAplyCom.userid,
                    bzn:finAplyCom.bzn,
...
FIN02002P00Component.prototype.onSave = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FIN02002P00.saveArr(FAS03010101s);
                FIN02002P00.saveArr(FAS03010102s);  //재고자산
                FIN02002P00.saveArr(FAS03010201s);  //투자자산
                FIN02002P00.saveArr(FAS03010202s);  //유형자산
                FIN02002P00.saveArr(FAS03010203s);  //무형자산
                FIN02002P00.saveArr(FAS03010204s);  //기타비유동자산
                FIN02002P00.saveArr(FAS03010301s);  //유동부채                
                FIN02002P00.saveArr(FAS03010401s);  //비유동부채
                FIN02002P00.saveArr(FAS03010501s);  //자본

                FIN02002P00.saveArr(FAS03020101s);  //매출
                FIN02002P00.saveArr(FAS03020201s);  //판매관리비
                FIN02002P00.saveArr(FAS03020301s);  //영업외수익
                FIN02002P00.saveArr(FAS03020401s);  //영업외비용
                FIN02002P00.saveArr(FAS03020501s);  //법인세     

                FIN02002P00.saveArr(FAS03030101s);  //당기총제조비용
                FIN02002P00.saveArr(FAS03030201s);  //경비
                FIN02002P00.saveArr(FAS03030301s);  //기타

                FIN02002P00.saveArr(FAS03040101s);  //법인세차감전순이익
                FIN02002P00.saveArr(FAS03040201s);  //인건비
                FIN02002P00.saveArr(FAS03040301s);  //금융비용
                FIN02002P00.saveArr(FAS03040401s);  //임차료
                FIN02002P00.saveArr(FAS03040501s);  //조세공과
                FIN02002P00.saveArr(FAS03040601s);  //감가상각비

                FIN02002P00.onAllRgsn();
...
FIN02002P00Component.prototype.saveFAS0304 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FIN02002P00.saveArr(FAS03040101s);  
                FIN02002P00.saveArr(FAS03040201s);  
                FIN02002P00.saveArr(FAS03040301s);  
                FIN02002P00.saveArr(FAS03040401s);  
                FIN02002P00.saveArr(FAS03040501s);  
                FIN02002P00.saveArr(FAS03040601s);  
...
FIN02002P00Component.prototype.initFAS0304 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FAS03040101s = FIN02002P00.initArr(FAS03040101s);  
                FAS03040201s = FIN02002P00.initArr(FAS03040201s);  
                FAS03040301s = FIN02002P00.initArr(FAS03040301s);  
                FAS03040401s = FIN02002P00.initArr(FAS03040401s);  
                FAS03040501s = FIN02002P00.initArr(FAS03040501s);  
                FAS03040601s = FIN02002P00.initArr(FAS03040601s); 

                setTimeout(FIN02002P00.initView, 2000);
...
FIN02002P00Component.prototype.initFAS0303 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FAS03030101s = FIN02002P00.initArr(FAS03030101s);  //당기총제조비용
                FAS03030201s = FIN02002P00.initArr(FAS03030201s);  //경비
                FAS03030301s = FIN02002P00.initArr(FAS03030301s);  //기타
...
FIN02002P00Component.prototype.saveFAS0303 = function() {
...
FIN02002P00Component.prototype.initFAS0302 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                FAS03020101s = FIN02002P00.initArr(FAS03020101s);  //매출
                FAS03020201s = FIN02002P00.initArr(FAS03020201s);  //판매관리비
                FAS03020301s = FIN02002P00.initArr(FAS03020301s);  //영업외수익
                FAS03020401s = FIN02002P00.initArr(FAS03020401s);  //영업외비용
                FAS03020501s = FIN02002P00.initArr(FAS03020501s);  //법인세
...
FIN02002P00Component.prototype.saveFAS0302 = function() {
...
FIN02002P00Component.prototype.initFAS0301 = function() {
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                var callFinArr = [];
                FAS03010101s = FIN02002P00.initArr(FAS03010101s);
                FAS03010102s = FIN02002P00.initArr(FAS03010102s);  //재고자산
                FAS03010201s = FIN02002P00.initArr(FAS03010201s);  //투자자산
                FAS03010202s = FIN02002P00.initArr(FAS03010202s);  //유형자산
                FAS03010203s = FIN02002P00.initArr(FAS03010203s);  //무형자산
                FAS03010204s = FIN02002P00.initArr(FAS03010204s);  //기타비유동자산
                FAS03010301s = FIN02002P00.initArr(FAS03010301s);  //유동부채                
                FAS03010401s = FIN02002P00.initArr(FAS03010401s);  //비유동부채
                FAS03010501s = FIN02002P00.initArr(FAS03010501s);  //자본
...
FIN02002P00Component.prototype.initView = function() {
    FIN02002P00.setAddValue();
    FIN02002P00.onView();
};

FIN02002P00Component.prototype.saveFAS0301 = function() {
...
FIN02002P00Component.prototype.onRgsn = function() {

    overlay.show();

    FIN02002P00.onSetValue();

    finService.saveAnalysisFinDt(finfnaminfos, FIN02002P00.callback);

};

FIN02002P00Component.prototype.onAllRgsn = function() {

    overlay.show();

    FIN02002P00.onSetValue();

    finService.saveAnalysisFinDt(finfnaminfos, FIN02002P00.allCallback);

};

FIN02002P00Component.prototype.callback = function(data) {
...
FIN02002P00Component.prototype.allCallback = function(data) {
...
FIN02002P00Component.prototype.initArr = function(arr) {
    var initFin = [];
    var initparam = {};
    for (var i = 0; i < arr.length; i++) {
