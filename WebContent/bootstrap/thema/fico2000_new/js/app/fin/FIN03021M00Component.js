...
var FIN03021M00 = new FIN03021M00Component();
...
function FIN03021M00Component() {

};

FIN03021M00Component.prototype.ngOnInit = function () {
    ...
    // function() {
        ...
        $("#stacYyInfo_1").on("change", function(){
            ...
            $("span[name='stacYyNm']").each(function (idx) {
                $("span[name='stacYyNm']").eq(idx).html(stacYy);
            });
            ...
            alyDataSet.forEach(function(selectedRaw, index) {
                ...
                if (selectedRaw.stacYy == stacYy) {
                    ...
                    FIN03021M00.onFinInit();

                    FIN03021M00.onBalance(selectedRaw);

                    // FIN03021M00.onIncome(selectedRaw);
                    // FIN03021M00.onCost(selectedRaw);
                    // FIN03021M00.onAddedValue(selectedRaw);
...
FIN03021M00Component.prototype.onFinInit = function() {
...
FIN03021M00Component.prototype.onSearch = function () {

        
    overlay.show();


        entpName = finAplyCom.entpName;
        ...
        console.log('onSearch stacYy >>>' , stacYy);

        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03021M00.finAnalyCallback);

};


FIN03021M00Component.prototype.finAnalyCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            FIN03021M00.onBalance(res.data.list1[0]);
            FIN03021M00.onIncome(res.data.list1[0]);
            FIN03021M00.onCost(res.data.list1[0]);
            FIN03021M00.onAddedValue(res.data.list1[0]);
...
FIN03021M00Component.prototype.onBalance = function(res) {
...
FIN03021M00Component.prototype.onIncome = function(res) {
...
FIN03021M00Component.prototype.onCost = function(res) {
...
FIN03021M00Component.prototype.onAddedValue = function(res) {
        ...
        FIN03021M00.setAddValue();

};

FIN03021M00Component.prototype.setAddValue = function() {
...
FIN03021M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03021M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03021M00Component.prototype.getBsTotal = function(accd) {
...
FIN03021M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03021M00Component.prototype.getCostTotal = function(accd) {
...
FIN03021M00Component.prototype.onToolTip = function () {
...
FIN03021M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03021M00Component.prototype.onView = function() {

    FIN03021M00.onDebtTableView();
    FIN03021M00.onBsTableView();
};


FIN03021M00Component.prototype.onBsTableView = function() {

var bsTable = "";
bsTable += "  <tr class='active'>																							";
bsTable += "      <td>유동자산</td>                                                                                          ";
bsTable += "      <td>"+FIN03021M00.getBsTotal('FAS030101')+"</td>                                                          ";
bsTable += "  </tr>                                                                                                         ";
bsTable += "  <tr class='active'>                                                                                           ";
bsTable += "      <td style='background-color:#ffa31c;color:#fff;'>당좌자산</td>                                             ";
bsTable += "      <td style='background-color:#ffa31c;color:#fff;'>"+FIN03021M00.getBsTotal('FAS03010101')+"</td>           ";
bsTable += "  </tr>                                                                                                         ";

for (var i = 0; i < FAS03010101s.length; i++) {
bsTable += "  <tr>															                                                ";
bsTable += "      <td>"+FAS03010101s[i].finSmdcdNm+"</td>                                                                   ";
bsTable += "      <td>"+FIN03021M00.onNumberWithCommas(FAS03010101s[i].finAmt)+"</td>                                       ";
bsTable += "  </tr>                                                                                                         ";    
}

bsTable += "  <tr class='active'>                                                                                           ";
bsTable += "      <td style='background-color:#00bcd4;color:#fff;'>재고자산</td>                                             ";
bsTable += "      <td style='background-color:#00bcd4;color:#fff;'>"+FIN03021M00.getBsTotal('FAS03010102')+"</td>                     ";
bsTable += "  </tr>                                                                                                         ";

for (var i = 0; i < FAS03010102s.length; i++) {
bsTable += "  <tr>															                                                ";
bsTable += "      <td>"+FAS03010102s[i].finSmdcdNm+"</td>                                                                   ";
bsTable += "      <td>"+FIN03021M00.onNumberWithCommas(FAS03010102s[i].finAmt)+"</td>                                       ";
bsTable += "  </tr>                                                                                                         ";    
}

bsTable += "  <tr class='active'>                                                                                           ";
bsTable += "      <td>비유동자산</td>                                                                                        ";
bsTable += "      <td>"+FIN03021M00.getBsTotal('FAS030102')+"</td>                                                                    ";
bsTable += "  </tr>                                                                                                         ";
bsTable += "  <tr>                                                                                                          ";
bsTable += "      <td style='background-color:#a6c600;color:#fff;'>투자자산</td>                                             ";
bsTable += "      <td style='background-color:#a6c600;color:#fff;'>"+FIN03021M00.getBsTotal('FAS03010201')+"</td>                     ";
bsTable += "  </tr>                                                                                                         ";

for (var i = 0; i < FAS03010201s.length; i++) {
bsTable += "  <tr>															                                                ";
bsTable += "      <td>"+FAS03010201s[i].finSmdcdNm+"</td>                                                                   ";
bsTable += "      <td>"+FIN03021M00.onNumberWithCommas(FAS03010201s[i].finAmt)+"</td>                                       ";
bsTable += "  </tr>                                                                                                         ";    
}
...
bsTable += "      <td style='background-color:#177bbb;color:#fff;'>"+FIN03021M00.getBsTotal('FAS03010202')+"</td>                     ";
bsTable += "  </tr>                                                                                                         ";

for (var i = 0; i < FAS03010202s.length; i++) {
bsTable += "  <tr>															                                                ";
bsTable += "      <td>"+FAS03010202s[i].finSmdcdNm+"</td>                                                                   ";
bsTable += "      <td>"+FIN03021M00.onNumberWithCommas(FAS03010202s[i].finAmt)+"</td>                                       ";
bsTable += "  </tr>                                                                                                         ";    
}
...
bsTable += "      <td style='background-color:#8669CC;color:#fff;'>"+FIN03021M00.getBsTotal('FAS03010203')+"</td>                     ";
bsTable += "  </tr>                                                                                                         ";

for (var i = 0; i < FAS03010203s.length; i++) {
bsTable += "  <tr>															                                                ";
bsTable += "      <td>"+FAS03010203s[i].finSmdcdNm+"</td>                                                                   ";
bsTable += "      <td>"+FIN03021M00.onNumberWithCommas(FAS03010203s[i].finAmt)+"</td>                                       ";
bsTable += "  </tr>                                                                                                         ";    
}
...
bsTable += "      <td style='background-color:#ffa31c;color:#fff;'>"+FIN03021M00.getBsTotal('FAS03010204')+"</td>                     ";
bsTable += "  </tr>                                                                                                         ";

for (var i = 0; i < FAS03010204s.length; i++) {
bsTable += "  <tr>															                                                ";
bsTable += "      <td>"+FAS03010204s[i].finSmdcdNm+"</td>                                                                   ";
bsTable += "      <td>"+FIN03021M00.onNumberWithCommas(FAS03010204s[i].finAmt)+"</td>                                       ";
bsTable += "  </tr>                                                                                                         ";    
}
...
bsTable += "  <tr class='active'>                                                                                           ";
bsTable += "      <td>자산총계</td>                                                                                          ";
bsTable += "      <td>"+FIN03021M00.getBsTotal('FAS030101T')+"</td>  ";
bsTable += "  </tr>																											";
...
FIN03021M00Component.prototype.onDebtTableView = function() {

    var debtTable = "";

debtTable += "<tr class='active'>																			";
debtTable += "    <td style='background-color:#ffa31c;color:#fff;'>유동부채</td>                           ";
debtTable += "    <td style='background-color:#ffa31c;color:#fff;'>"+FIN03021M00.getBsTotal('FAS030103')+"</td>     ";
debtTable += "</tr>                                                                                       ";
...
debtTable += "      <td>"+FIN03021M00.onNumberWithCommas(FAS03010301s[i].finAmt)+"</td>                                       ";
debtTable += "  </tr>                                                                                                         ";    
}
debtTable += "<tr class='active'>                                                                         ";
debtTable += "    <td style='background-color:#00bcd4;color:#fff;'>비유동부채</td>                         ";
debtTable += "    <td style='background-color:#00bcd4;color:#fff;'>"+FIN03021M00.getBsTotal('FAS030104')+"</td>      ";
debtTable += "</tr>                                                                                       ";
for (var i = 0; i < FAS03010401s.length; i++) {
debtTable += "  <tr>															                                                ";
debtTable += "      <td>"+FAS03010401s[i].finSmdcdNm+"</td>                                                                   ";
debtTable += "      <td>"+FIN03021M00.onNumberWithCommas(FAS03010401s[i].finAmt)+"</td>                                       ";
debtTable += "  </tr>                                                                                                         ";    
}
debtTable += "<tr class='active'>                                                                         ";
debtTable += "    <td style='background-color:#a6c600;color:#fff;'>자본</td>                               ";
debtTable += "    <td style='background-color:#a6c600;color:#fff;'>"+FIN03021M00.getBsTotal('FAS030105')+"</td>     ";
debtTable += "</tr>                                                                                       ";
for (var i = 0; i < FAS03010501s.length; i++) {
debtTable += "  <tr>															                                                ";
debtTable += "      <td>"+FAS03010501s[i].finSmdcdNm+"</td>                                                                   ";
debtTable += "      <td>"+FIN03021M00.onNumberWithCommas(FAS03010501s[i].finAmt)+"</td>                                       ";
debtTable += "  </tr>                                                                                                         ";    
}
debtTable += "<tr class='active'>                                                                         ";
debtTable += "    <td>부채 및 자본 합계</td>                                                                ";
debtTable += "    <td>"+FIN03021M00.getBsTotal('FAS030103T')+"</td>                                                 ";
debtTable += "</tr>                                                                                       ";
    ...
    console.log('debtTable >>> ', debtTable);
};


FIN03021M00Component.prototype.setBalanceBaseDataSet = function() {
        ...
        dataSet = FIN03021M00.setDataSet(arr, dataSet);
        dataSet = FIN03021M00.setDataSet(arr1, dataSet);
        dataSet = FIN03021M00.setDataSet(arr2, dataSet);
        dataSet = FIN03021M00.setDataSet(arr3, dataSet);
        dataSet = FIN03021M00.setDataSet(arr4, dataSet);


        return dataSet;
};

FIN03021M00Component.prototype.setBalanceDataSet = function() {
...
FIN03021M00Component.prototype.setBalanceBaseDataSet01 = function() { //부채 및 자본
...
FIN03021M00Component.prototype.setBalanceDataSet01 = function() {
...
FIN03021M00Component.prototype.setIncomeBaseDataSet = function() {
        ...
        dataSet = FIN03021M00.setDataSet01(arr, dataSet);
        dataSet = FIN03021M00.setDataSet01(arr1, dataSet);
        dataSet = FIN03021M00.setDataSet01(arr2, dataSet);

        return dataSet;

};

FIN03021M00Component.prototype.setIncomeDataSet = function() {
        ...
        dataSet = FIN03021M00.setDataSet(arr3, dataSet);
        dataSet = FIN03021M00.setDataSet(arr4, dataSet);
        dataSet = FIN03021M00.setDataSet(arr5, dataSet);
        dataSet = FIN03021M00.setDataSet(arr6, dataSet);
        dataSet = FIN03021M00.setDataSet(arr7, dataSet);
        dataSet = FIN03021M00.setDataSet(arr8, dataSet);

        return dataSet;

};  
    
FIN03021M00Component.prototype.setIncomeDataSet01 = function() {
...
FIN03021M00Component.prototype.setCostBaseDataSet = function() {
        ...
        dataSet = FIN03021M00.setDataSet01(arr1, dataSet);
        dataSet = FIN03021M00.setDataSet01(arr2, dataSet);
        dataSet = FIN03021M00.setDataSet01(arr3, dataSet);
        dataSet = FIN03021M00.setDataSet01(arr4, dataSet);                

        return dataSet;

    }   
FIN03021M00Component.prototype.setAddValueBaseDataSet = function() {
...
FIN03021M00Component.prototype.setDataSet = function(arr, dataSet) {
...
FIN03021M00Component.prototype.setDataSet01 = function(arr, dataSet) {
...
FIN03021M00Component.prototype.onPlot = function() {

    var dataSet = [];

    dataSet = FIN03021M00.setBalanceBaseDataSet();
...
FIN03021M00Component.prototype.onPlot1 = function() {
...
FIN03021M00Component.prototype.onPlot2 = function() {
    ...
    dataSet = FIN03021M00.setBalanceDataSet();
...
FIN03021M00Component.prototype.onPlot3 = function() {

    // =================================================================
    // 부채및자본구성비연도별그래프
    // =================================================================

    var dataSet01 = FIN03021M00.setBalanceBaseDataSet01();
...
FIN03021M00Component.prototype.onPlot4 = function() {
...
FIN03021M00Component.prototype.onPlot5 = function() {
    // =================================================================
    // 부채 및 자본 구성비 (연도별/전체 항목)
    // =================================================================
    var dataSet = [];  
    
    dataSet = FIN03021M00.setBalanceDataSet01();
...
FIN03021M00Component.prototype.onPlot6 = function() {
     // =================================================================
    // 매출액연도별그래프
    // =================================================================
    dataSet = [];

    dataSet = FIN03021M00.setIncomeDataSet();
...
FIN03021M00Component.prototype.onPlot7 = function() {
    // =================================================================
    // 매출액변화(연도별/전체 항목)
    // =================================================================
    var dataSet = [];

    dataSet = FIN03021M00.setIncomeBaseDataSet();
...
FIN03021M00Component.prototype.onPlot8 = function() {
   // =================================================================
    // 자산구성비연도별그래프
    // =================================================================
    var dataSet = [];

    dataSet = FIN03021M00.setCostBaseDataSet();
...
FIN03021M00Component.prototype.setWallTrantPlot = function(dataSet) {
...
FIN03021M00Component.prototype.onPlot9 = function() {
...
FIN03021M00Component.prototype.onPlot10 = function() {
        // =================================================================
        // 자산구성비연도별그래프
        // =================================================================
        ...
        dataSet = FIN03021M00.setAddValueBaseDataSet();
...
function onStacYyChange01(event) {
        ...
        FIN03021M00.onFinRatioTableView();
...
function onStacYyChange03(event) {
        ...
        FIN03021M00.decisionRatioTable();
...
function onRadioClick(obj) {
        ...
        finService.getDecisionRatio(finCom.alyid, finCom.userid, finCom.bzn, lastest, enslDcd, FIN03021M00.decisionCallBack);

        wallTrantArray = [];

        finService.getWallTrantRatio(finCom.alyid, finCom.userid, finCom.bzn, lastest, enslDcd, FIN03021M00.wallTrantCallback);

        finService.getFinRatio(finCom.alyid, finCom.userid, finCom.bzn, lastest, enslDcd, FIN03021M00.finRateCallback);
