...
var FIN03013M00 = new FIN03013M00Component();
...
function FIN03013M00Component() {

};

FIN03013M00Component.prototype.ngOnInit = function () {
...
FIN03013M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03013M00.finAnalyCallback);


};


FIN03013M00Component.prototype.finAnalyCallback = function(data) {
...
FIN03013M00Component.prototype.onBalance = function(res) {
...
FIN03013M00Component.prototype.onIncome = function(res) {
...
FIN03013M00Component.prototype.onCost = function(res) {
...
FIN03013M00Component.prototype.onAddedValue = function(res) {
    ...
    FIN03013M00.setAddValue();

};

FIN03013M00Component.prototype.setAddValue = function() {
...
FIN03013M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03013M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03013M00Component.prototype.getBsTotal = function(accd) {
...
FIN03013M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03013M00Component.prototype.getCostTotal = function(accd) {
...
FIN03013M00Component.prototype.setBalanceBaseDataSet01 = function() { //부채 및 자본
    ...
    dataSet = FIN03013M00.setDataSet(arr, dataSet);
    dataSet = FIN03013M00.setDataSet(arr1, dataSet);
    dataSet = FIN03013M00.setDataSet(arr2, dataSet);

    return dataSet;

};

FIN03013M00Component.prototype.setDataSet = function(arr, dataSet) {
...
FIN03013M00Component.prototype.onPlot = function() {

    // =================================================================
    // 부채및자본구성비연도별그래프
    // =================================================================

    var dataSet01 = FIN03013M00.setBalanceBaseDataSet01();
...
FIN03013M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03013M00Component.prototype.onFinResult = function () {
