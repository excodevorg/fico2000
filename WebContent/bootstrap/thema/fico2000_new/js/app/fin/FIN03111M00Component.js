...
var FIN03111M00 = new FIN03111M00Component();
...
function FIN03111M00Component() {

};

FIN03111M00Component.prototype.ngOnInit = function () {
...
FIN03111M00Component.prototype.onSearch = function () {
        ...
        finService.getDecisionRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y","", FIN03111M00.decisionCallBack);
};


FIN03111M00Component.prototype.decisionCallBack = function (data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < res.data.stacYys.length; i++) {
                bsTable += FIN03111M00.onDesisionBaseTableView(i, res.data.stacYys[i].name);
            }
            ...
            finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y", enslDcd, FIN03111M00.finRateCallback);

            //FIN03111M00.decisionRatioTable();

            //finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, lastest, enslDcd, FIN03111M00.finRateCallback);
...
FIN03111M00Component.prototype.onDesisionBaseTableView = function(idx, stacYyName) {
    ...
    bsTable += '<h3 class="panel-title">재무진단 현황 (<span name="enslDcdNm"/>)</h3>';
    bsTable += '</div>';
...
FIN03111M00Component.prototype.decisionRatioTable = function(idx) {
...
FIN03111M00Component.prototype.finRateCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < decisionSet.stacYys.length; i++) {
                ...
                FIN03111M00.decisionRatioTable(i);
...
FIN03111M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03111M00Component.prototype.onFinResult = function () {
