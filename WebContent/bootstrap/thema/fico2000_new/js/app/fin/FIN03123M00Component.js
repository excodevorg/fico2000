...
var FIN03123M00 = new FIN03123M00Component();
...
function FIN03123M00Component() {

};

FIN03123M00Component.prototype.ngOnInit = function () {
...
FIN03123M00Component.prototype.onSearch = function () {
        ...
        finService.getDecisionRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y","", FIN03123M00.decisionCallBack);
};


FIN03123M00Component.prototype.decisionCallBack = function (data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < res.data.stacYys.length; i++) {
                bsTable += FIN03123M00.onDesisionBaseTableView(i, res.data.stacYys[i].name);
            }
            ...
            finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y", enslDcd, FIN03123M00.finRateCallback);

            //FIN03123M00.decisionRatioTable();

            //finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, lastest, enslDcd, FIN03123M00.finRateCallback);
...
FIN03123M00Component.prototype.onDesisionBaseTableView = function(idx, stacYyName) {
...
FIN03123M00Component.prototype.decisionRatioTable = function(idx) {
    ...
    if (decprofitArray[i].finresult == 'BAD') decisionRatioTable += "<td style='cursor:pointer;'><span title='(기) "+profitArray[i].finRatio+" vs (한) "+profitArray[i].bokAllRatio+"' class='label label-table label-danger'>"+decprofitArray[i].bokresult+"</span></td>";
    if (decprofitArray[i].finresult == 'GOOD') decisionRatioTable += "<td style='cursor:pointer;'><span title='(기) "+profitArray[i].finRatio+" vs (한) "+profitArray[i].bokAllRatio+"' class='label label-table label-success'>"+decprofitArray[i].bokresult+"</span></td>";
    decisionRatioTable += "  </tr>                                                                                                         ";    
    }
...
FIN03123M00Component.prototype.finRateCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < decisionSet.stacYys.length; i++) {
                ...
                FIN03123M00.decisionRatioTable(i);
...
FIN03123M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03123M00Component.prototype.onFinResult = function () {
