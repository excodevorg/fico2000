...
var FIN04001M00 = new FIN04001M00Component();

function FIN04001M00Component() {

};

FIN04001M00Component.prototype.ngOnInit = function () {
    ...
    $("#onFinResult").click(function(){
        FIN04001M00.onFinResult();
    });

    FIN04001M00.onSearch();
};


FIN04001M00Component.prototype.onSearch = function () {
...
FIN04001M00Component.prototype.onFinResult = function () {
