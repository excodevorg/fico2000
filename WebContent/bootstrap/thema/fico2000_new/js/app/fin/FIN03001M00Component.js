...
FIN03001M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03001M00.finAnalyCallback);


};


FIN03001M00Component.prototype.finAnalyCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            alyDataSet.forEach(function(selectedRaw, index) {
                ...
                FIN03001M00.onBalance(selectedRaw);
                FIN03001M00.onIncome(selectedRaw);
                FIN03001M00.onCost(selectedRaw);
                FIN03001M00.onAddedValue(selectedRaw);

                bsTable += FIN03001M00.onBsTableView(index);
...
FIN03001M00Component.prototype.onBalance = function(res) {
...
FIN03001M00Component.prototype.onIncome = function(res) {
...
FIN03001M00Component.prototype.onCost = function(res) {
...
FIN03001M00Component.prototype.onAddedValue = function(res) {
    ...
    FIN03001M00.setAddValue();

};

FIN03001M00Component.prototype.setAddValue = function() {
...
FIN03001M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03001M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03001M00Component.prototype.getBsTotal = function(accd) {
...
FIN03001M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03001M00Component.prototype.getCostTotal = function(accd) {
...
FIN03001M00Component.prototype.onBsTableView = function(idx) {
    ...
    bsTable += '<h3 class="panel-title">자산 ('+finAplyCom.stacYys[idx]+' 재무정보)</h3>';
    bsTable += '</div>';
    bsTable += '<div class="panel-body">';
    bsTable += '<table id="bsTable" class="table  table-condensed">';
    bsTable += '<thead>';
    bsTable += '<tr>';
    bsTable += '<th>항목</th>';
    ...
    bsTable += "      <td>유동자산</td>                                                                                          ";
    bsTable += "      <td>"+FIN03001M00.getBsTotal('FAS030101')+"</td>                                                          ";
    bsTable += "  </tr>                                                                                                         ";
    bsTable += "  <tr class='active'>                                                                                           ";
    bsTable += "      <td style='background-color:#ffa31c;color:#fff;'>당좌자산</td>                                             ";
    bsTable += "      <td style='background-color:#ffa31c;color:#fff;'>"+FIN03001M00.getBsTotal('FAS03010101')+"</td>           ";
    bsTable += "  </tr>                                                                                                         ";
    
    for (var i = 0; i < FAS03010101s.length; i++) {
    bsTable += "  <tr>															                                                ";
    bsTable += "      <td>"+FAS03010101s[i].finSmdcdNm+"</td>                                                                   ";
    bsTable += "      <td>"+FIN03001M00.onNumberWithCommas(FAS03010101s[i].finAmt)+"</td>                                       ";
    bsTable += "  </tr>                                                                                                         ";    
    }
    
    bsTable += "  <tr class='active'>                                                                                           ";
    bsTable += "      <td style='background-color:#00bcd4;color:#fff;'>재고자산</td>                                             ";
    bsTable += "      <td style='background-color:#00bcd4;color:#fff;'>"+FIN03001M00.getBsTotal('FAS03010102')+"</td>                     ";
    bsTable += "  </tr>                                                                                                         ";
    
    for (var i = 0; i < FAS03010102s.length; i++) {
    bsTable += "  <tr>															                                                ";
    bsTable += "      <td>"+FAS03010102s[i].finSmdcdNm+"</td>                                                                   ";
    bsTable += "      <td>"+FIN03001M00.onNumberWithCommas(FAS03010102s[i].finAmt)+"</td>                                       ";
    bsTable += "  </tr>                                                                                                         ";    
    }
    
    bsTable += "  <tr class='active'>                                                                                           ";
    bsTable += "      <td>비유동자산</td>                                                                                        ";
    bsTable += "      <td>"+FIN03001M00.getBsTotal('FAS030102')+"</td>                                                                    ";
    bsTable += "  </tr>                                                                                                         ";
    bsTable += "  <tr>                                                                                                          ";
    bsTable += "      <td style='background-color:#a6c600;color:#fff;'>투자자산</td>                                             ";
    bsTable += "      <td style='background-color:#a6c600;color:#fff;'>"+FIN03001M00.getBsTotal('FAS03010201')+"</td>                     ";
    bsTable += "  </tr>                                                                                                         ";
    
    for (var i = 0; i < FAS03010201s.length; i++) {
    bsTable += "  <tr>															                                                ";
    bsTable += "      <td>"+FAS03010201s[i].finSmdcdNm+"</td>                                                                   ";
    bsTable += "      <td>"+FIN03001M00.onNumberWithCommas(FAS03010201s[i].finAmt)+"</td>                                       ";
    bsTable += "  </tr>                                                                                                         ";    
    }
    ...
    bsTable += "      <td style='background-color:#177bbb;color:#fff;'>"+FIN03001M00.getBsTotal('FAS03010202')+"</td>                     ";
    bsTable += "  </tr>                                                                                                         ";
    
    for (var i = 0; i < FAS03010202s.length; i++) {
    bsTable += "  <tr>															                                                ";
    bsTable += "      <td>"+FAS03010202s[i].finSmdcdNm+"</td>                                                                   ";
    bsTable += "      <td>"+FIN03001M00.onNumberWithCommas(FAS03010202s[i].finAmt)+"</td>                                       ";
    bsTable += "  </tr>                                                                                                         ";    
    }
    ...
    bsTable += "      <td style='background-color:#8669CC;color:#fff;'>"+FIN03001M00.getBsTotal('FAS03010203')+"</td>                     ";
    bsTable += "  </tr>                                                                                                         ";
    
    for (var i = 0; i < FAS03010203s.length; i++) {
    bsTable += "  <tr>															                                                ";
    bsTable += "      <td>"+FAS03010203s[i].finSmdcdNm+"</td>                                                                   ";
    bsTable += "      <td>"+FIN03001M00.onNumberWithCommas(FAS03010203s[i].finAmt)+"</td>                                       ";
    bsTable += "  </tr>                                                                                                         ";    
    }
    ...
    bsTable += "      <td style='background-color:#ffa31c;color:#fff;'>"+FIN03001M00.getBsTotal('FAS03010204')+"</td>                     ";
    bsTable += "  </tr>                                                                                                         ";
    
    for (var i = 0; i < FAS03010204s.length; i++) {
    bsTable += "  <tr>															                                                ";
    bsTable += "      <td>"+FAS03010204s[i].finSmdcdNm+"</td>                                                                   ";
    bsTable += "      <td>"+FIN03001M00.onNumberWithCommas(FAS03010204s[i].finAmt)+"</td>                                       ";
    bsTable += "  </tr>                                                                                                         ";    
    }
    ...
    bsTable += "  <tr class='active'>                                                                                           ";
    bsTable += "      <td>자산총계</td>                                                                                          ";
    bsTable += "      <td>"+FIN03001M00.getBsTotal('FAS030101T')+"</td>  ";
    bsTable += "  </tr>																											";
...
FIN03001M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};
