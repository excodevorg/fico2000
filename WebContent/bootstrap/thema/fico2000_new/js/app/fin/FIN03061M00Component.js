...
var FIN03061M00 = new FIN03061M00Component();
...
function FIN03061M00Component() {

};

FIN03061M00Component.prototype.ngOnInit = function () {
...
FIN03061M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03061M00.finAnalyCallback);


};


FIN03061M00Component.prototype.finAnalyCallback = function(data) {
...
FIN03061M00Component.prototype.onBalance = function(res) {
...
FIN03061M00Component.prototype.onIncome = function(res) {
...
FIN03061M00Component.prototype.onCost = function(res) {
...
FIN03061M00Component.prototype.onAddedValue = function(res) {
    ...
    FIN03061M00.setAddValue();

};

FIN03061M00Component.prototype.setAddValue = function() {
...
FIN03061M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03061M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03061M00Component.prototype.getBsTotal = function(accd) {
...
FIN03061M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03061M00Component.prototype.getCostTotal = function(accd) {
...
FIN03061M00Component.prototype.setAddValueBaseDataSet = function() {
    ...
    dataSet = FIN03061M00.setDataSet01(arr, dataSet);
    dataSet = FIN03061M00.setDataSet01(arr1, dataSet);
    dataSet = FIN03061M00.setDataSet01(arr2, dataSet);
    dataSet = FIN03061M00.setDataSet01(arr3, dataSet);
    dataSet = FIN03061M00.setDataSet01(arr4, dataSet);                

    return dataSet;

};

FIN03061M00Component.prototype.setDataSet01 = function(arr, dataSet) {
...
FIN03061M00Component.prototype.onPlot = function() {

    var dataSet = [];

    dataSet = FIN03061M00.setAddValueBaseDataSet();
...
FIN03061M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03061M00Component.prototype.onFinResult = function () {
