var FIN03212M00 = new FIN03212M00Component();
...
function FIN03212M00Component() {

};

FIN03212M00Component.prototype.ngOnInit = function () {
...
FIN03212M00Component.prototype.onSearch = function () {
    FIN03212M00.initQsrtSave();
};

FIN03212M00Component.prototype.onBusinessWorkPattern = function() {

    console.log("<<<<<< onBusinessWorkPattern() start >>>>> ");
    overlay.show();
    finService.getBusinessWorkPattern(finAplyCom.alyid, finAplyCom.stacYy, qsrtInfo, FIN03212M00.BusinessWorkPatternCallback);

};

FIN03212M00Component.prototype.BusinessWorkPatternCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            FIN03212M00.BusinessWorkPatternView();

            FIN03212M00.setBusinessWorkPattern(result);
...
FIN03212M00Component.prototype.BusinessWorkPatternView = function() {
    ...
    cashComePatternsDis += '            <span class="text-3x text-thin">'+FIN03212M00.onNumberWithCommas(businessWorkPatterns['rsv08'])+'</span>                        ';
    cashComePatternsDis += '            <p>1) 생산, 판매, 일반관리비<br/>'+FIN03212M00.onNumberWithCommas(businessWorkPatterns['rsv08'])+' 이 지출됨</p>                   ';
    cashComePatternsDis += '                                                                                                                                            ';
    cashComePatternsDis += '            <br/>                                                                                                                           ';
    cashComePatternsDis += '            <span class="text-3x text-thin">'+FIN03212M00.onNumberWithCommas(businessWorkPatterns['rsv09'])+'</span>                        ';
    cashComePatternsDis += '            <p>2) 은행권에서 받은 대출<br/>이자비용<br/>매월 '+FIN03212M00.onNumberWithCommas(businessWorkPatterns['rsv09'])+' 을 납부 함</p>  ';
    ...
    cashComePatternsDis += '            <span class="text-3x text-thin">'+FIN03212M00.onNumberWithCommas((businessWorkPatterns['rsv10'])['amt'])+'</span>               ';
    cashComePatternsDis += '            <p>'+(businessWorkPatterns['rsv10'])['month']+'월에 '+FIN03212M00.onNumberWithCommas((businessWorkPatterns['rsv10'])['amt'])+'을 납부함</p>  	';
    cashComePatternsDis += '        </div>                                                                                                                              ';
    cashComePatternsDis += '    </div>                                                                                                                                  ';
    }
    cashComePatternsDis += '</div>                                                                                                                                      ';
    ...
    cashComePatternsDis += '            <span class="text-3x text-thin">'+FIN03212M00.onNumberWithCommas(businessWorkPatterns['rsv11'])+'</span>                        ';
    cashComePatternsDis += '        </div>                                                                                                                              ';
    cashComePatternsDis += '    </div>                                                                                                                                  ';
    }
    cashComePatternsDis += '</div>                                                                                                                                      ';
    ...
    cashComePatternsDis += '            <span class="text-3x text-thin">'+FIN03212M00.onNumberWithCommas(businessWorkPatterns['rsv12'])+'</span>                        ';
    cashComePatternsDis += '        </div>                                                                                                                              ';
    cashComePatternsDis += '    </div>                                                                                                                                  ';
    }
    cashComePatternsDis += '</div>                                                                                                                                      ';
    ...
    cashComePatternsDis += '            <span class="text-3x text-thin">'+FIN03212M00.onNumberWithCommas((businessWorkPatterns['rsv13'])['amt'])+'</span>               ';
    cashComePatternsDis += '            <p>'+(businessWorkPatterns['rsv13'])['month']+'월에 '+FIN03212M00.onNumberWithCommas((businessWorkPatterns['rsv13'])['amt'])+' 받음</p>    	';
    cashComePatternsDis += '        </div>                                                                                                                              ';
    cashComePatternsDis += '    </div>                                                                                                                                  ';
    }
    cashComePatternsDis += '</div>                                                                                                                                      ';
...
FIN03212M00Component.prototype.setBusinessWorkPattern = function(data) {
...
FIN03212M00Component.prototype.onPlot = function(){
...
FIN03212M00Component.prototype.initQsrtSave = function() {
    overlay.show();
    console.log("initQsrtSave >>> start >>>>" , finAplyCom);
    var res = finService.getQsrtMngRsltInfoList(finAplyCom.alyid, finAplyCom.stacYy, FIN03212M00.qsrtMngRsltCallback);
};

FIN03212M00Component.prototype.qsrtMngRsltCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            FIN03212M00.onQstrInfo(res);
            FIN03212M00.onBusinessWorkPattern();
            overlay.hide();
...
FIN03212M00Component.prototype.onQstrInfo = function(res) {
...
FIN03212M00Component.prototype.onNumberWithCommas = function(totalAmt) {
