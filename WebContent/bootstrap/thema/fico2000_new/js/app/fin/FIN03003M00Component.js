...
FIN03003M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03003M00.finAnalyCallback);


};


FIN03003M00Component.prototype.finAnalyCallback = function(data) {
...
FIN03003M00Component.prototype.onBalance = function(res) {
...
FIN03003M00Component.prototype.onIncome = function(res) {
...
FIN03003M00Component.prototype.onCost = function(res) {
...
FIN03003M00Component.prototype.onAddedValue = function(res) {
    ...
    FIN03003M00.setAddValue();

};

FIN03003M00Component.prototype.setAddValue = function() {
...
FIN03003M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03003M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03003M00Component.prototype.getBsTotal = function(accd) {
...
FIN03003M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03003M00Component.prototype.getCostTotal = function(accd) {
...
FIN03003M00Component.prototype.setBalanceBaseDataSet = function() {
    ...
    dataSet = FIN03003M00.setDataSet(arr, dataSet);
    dataSet = FIN03003M00.setDataSet(arr1, dataSet);
    dataSet = FIN03003M00.setDataSet(arr2, dataSet);
    dataSet = FIN03003M00.setDataSet(arr3, dataSet);
    dataSet = FIN03003M00.setDataSet(arr4, dataSet);


    return dataSet;
};

FIN03003M00Component.prototype.setDataSet = function(arr, dataSet) {
...
FIN03003M00Component.prototype.onPlot = function() {
    ...
    dataSet = FIN03003M00.setBalanceBaseDataSet();
...
FIN03003M00Component.prototype.onFinResult = function () {
