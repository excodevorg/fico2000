...
var FIN03041M00 = new FIN03041M00Component();
...
function FIN03041M00Component() {

};

FIN03041M00Component.prototype.ngOnInit = function () {
        ...
        $("#stacYyInfo_1").on("change", function(){
            ...
            alyDataSet.forEach(function(selectedRaw, index) {
                ...
                if (selectedRaw.stacYy == stacYy) {
                    ...
                    //FIN03041M00.onFinInit();

                    //FIN03041M00.onBalance(selectedRaw);

                    FIN03041M00.onIncome(selectedRaw);
                    // FIN03041M00.onCost(selectedRaw);
                    // FIN03041M00.onAddedValue(selectedRaw);
...
FIN03041M00Component.prototype.onFinInit = function() {
...
FIN03041M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03041M00.finAnalyCallback);

};


FIN03041M00Component.prototype.finAnalyCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            FIN03041M00.onBalance(res.data.list1[0]);
            FIN03041M00.onIncome(res.data.list1[0]);
            FIN03041M00.onCost(res.data.list1[0]);
            FIN03041M00.onAddedValue(res.data.list1[0]);
...
FIN03041M00Component.prototype.onBalance = function(res) {
...
FIN03041M00Component.prototype.onIncome = function(res) {
...
FIN03041M00Component.prototype.onCost = function(res) {
...
FIN03041M00Component.prototype.onAddedValue = function(res) {
        ...
        FIN03041M00.setAddValue();

};

FIN03041M00Component.prototype.setAddValue = function() {
...
FIN03041M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03041M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03041M00Component.prototype.getBsTotal = function(accd) {
...
FIN03041M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03041M00Component.prototype.getCostTotal = function(accd) {
...
FIN03041M00Component.prototype.onToolTip = function () {
...
FIN03041M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03041M00Component.prototype.onView = function() {

    FIN03041M00.onIncomeTableView();
};


FIN03041M00Component.prototype.onIncomeTableView = function() {

    var incomeTable = "";
    
    incomeTable += " <tr class='active'>									;"
    incomeTable += "     <td>매출액</td>                                    ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('FAS0302010101')+"</td>      ";
    incomeTable += " </tr>                                                 ";
    incomeTable += " <tr class='active'>                                   ";
    incomeTable += "     <td>매출원가</td>                                  ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('FAS0302010102')+"</td>      ";
    incomeTable += " </tr>                                                 ";
    incomeTable += " <tr class='active'>                                   ";
    incomeTable += "     <td>매출총손익</td>                                ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('amslTtalPlAmt')+"</td>      ";
    incomeTable += " </tr>                                                 ";
    incomeTable += " <tr class='active'>                                   ";
    incomeTable += "     <td>판매비와관리비</td>                             ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('FAS03020201')+"</td>      ";
    incomeTable += " </tr>                                                 ";
    
    for (var i = 0; i < FAS03020201s.length; i++) {
    incomeTable += "  <tr>															                                                ";
    incomeTable += "      <td>"+FAS03020201s[i].finSmdcdNm+"</td>                                                                   ";
    incomeTable += "      <td>"+FIN03041M00.onNumberWithCommas(FAS03020201s[i].finAmt)+"</td>                                       ";
    incomeTable += "  </tr>                                                                                                         ";    
    }
    
    incomeTable += " <tr class='active'>                                   ";
    incomeTable += "     <td>영업손익</td>                                  ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('bsopPlAmt')+"</td>      ";
    incomeTable += " </tr>                                                 ";
    incomeTable += "                                                       ";
    incomeTable += " <tr class='active'>                                   ";
    incomeTable += "     <td>영업외수익</td>                                ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('FAS03020301')+"</td>      ";
    incomeTable += " </tr>                                                 ";
    
    for (var i = 0; i < FAS03020301s.length; i++) {
    incomeTable += "  <tr>															                                                ";
    incomeTable += "      <td>"+FAS03020301s[i].finSmdcdNm+"</td>                                                                   ";
    incomeTable += "      <td>"+FIN03041M00.onNumberWithCommas(FAS03020301s[i].finAmt)+"</td>                                       ";
    incomeTable += "  </tr>                                                                                                         ";    
    }
    
    incomeTable += " <tr class='active'>                                   ";
    incomeTable += "     <td>영업외비용</td>                                ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('FAS03020401')+"</td>      ";
    incomeTable += " </tr>                                                 ";
    
    for (var i = 0; i < FAS03020401s.length; i++) {
    incomeTable += "  <tr>															                                                ";
    incomeTable += "      <td>"+FAS03020401s[i].finSmdcdNm+"</td>                                                                   ";
    incomeTable += "      <td>"+FIN03041M00.onNumberWithCommas(FAS03020401s[i].finAmt)+"</td>                                       ";
    incomeTable += "  </tr>                                                                                                         ";    
    }
    
    incomeTable += " <tr class='active'>                                   ";
    incomeTable += "     <td>법인세차감전순손익</td>                          ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('crtxSbbfNtprAmt')+"</td>      ";
    incomeTable += " </tr>                                                 ";
    incomeTable += " <tr class='active'>                                   ";
    incomeTable += "     <td>법인세비용</td>                                ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('FAS03020501')+"</td>      ";
    incomeTable += " </tr>                                                 ";
    incomeTable += " <tr class='active'>                                   ";
    incomeTable += "     <td>당기순손익</td>                                ";
    incomeTable += "     <td>"+FIN03041M00.getIncomeTotal('crtrNtPlAmt')+"</td>      ";
    incomeTable += " </tr>                                                 ";
...
FIN03041M00Component.prototype.setBalanceBaseDataSet = function() {
        ...
        dataSet = FIN03041M00.setDataSet(arr, dataSet);
        dataSet = FIN03041M00.setDataSet(arr1, dataSet);
        dataSet = FIN03041M00.setDataSet(arr2, dataSet);
        dataSet = FIN03041M00.setDataSet(arr3, dataSet);
        dataSet = FIN03041M00.setDataSet(arr4, dataSet);


        return dataSet;
};

FIN03041M00Component.prototype.setBalanceDataSet = function() {
...
FIN03041M00Component.prototype.setBalanceBaseDataSet01 = function() { //부채 및 자본
...
FIN03041M00Component.prototype.setBalanceDataSet01 = function() {
...
FIN03041M00Component.prototype.setIncomeBaseDataSet = function() {
        ...
        dataSet = FIN03041M00.setDataSet01(arr, dataSet);
        dataSet = FIN03041M00.setDataSet01(arr1, dataSet);
        dataSet = FIN03041M00.setDataSet01(arr2, dataSet);

        return dataSet;

};

FIN03041M00Component.prototype.setIncomeDataSet = function() {
        ...
        dataSet = FIN03041M00.setDataSet(arr3, dataSet);
        dataSet = FIN03041M00.setDataSet(arr4, dataSet);
        dataSet = FIN03041M00.setDataSet(arr5, dataSet);
        dataSet = FIN03041M00.setDataSet(arr6, dataSet);
        dataSet = FIN03041M00.setDataSet(arr7, dataSet);
        dataSet = FIN03041M00.setDataSet(arr8, dataSet);

        return dataSet;

};  
    
FIN03041M00Component.prototype.setIncomeDataSet01 = function() {
...
FIN03041M00Component.prototype.setCostBaseDataSet = function() {
        ...
        dataSet = FIN03041M00.setDataSet01(arr1, dataSet);
        dataSet = FIN03041M00.setDataSet01(arr2, dataSet);
        dataSet = FIN03041M00.setDataSet01(arr3, dataSet);
        dataSet = FIN03041M00.setDataSet01(arr4, dataSet);                

        return dataSet;

    }   
FIN03041M00Component.prototype.setAddValueBaseDataSet = function() {
...
FIN03041M00Component.prototype.setDataSet = function(arr, dataSet) {
...
FIN03041M00Component.prototype.setDataSet01 = function(arr, dataSet) {
...
FIN03041M00Component.prototype.onPlot = function() {

    var dataSet = [];

    dataSet = FIN03041M00.setBalanceBaseDataSet();
...
FIN03041M00Component.prototype.onPlot1 = function() {
...
FIN03041M00Component.prototype.onPlot2 = function() {
    ...
    dataSet = FIN03041M00.setBalanceDataSet();
...
FIN03041M00Component.prototype.onPlot3 = function() {

    // =================================================================
    // 부채및자본구성비연도별그래프
    // =================================================================

    var dataSet01 = FIN03041M00.setBalanceBaseDataSet01();
...
FIN03041M00Component.prototype.onPlot4 = function() {
...
FIN03041M00Component.prototype.onPlot5 = function() {
    // =================================================================
    // 부채 및 자본 구성비 (연도별/전체 항목)
    // =================================================================
    var dataSet = [];  
    
    dataSet = FIN03041M00.setBalanceDataSet01();
...
FIN03041M00Component.prototype.onPlot6 = function() {
     // =================================================================
    // 매출액연도별그래프
    // =================================================================
    dataSet = [];

    dataSet = FIN03041M00.setIncomeDataSet();
...
FIN03041M00Component.prototype.onPlot7 = function() {
    // =================================================================
    // 매출액변화(연도별/전체 항목)
    // =================================================================
    var dataSet = [];

    dataSet = FIN03041M00.setIncomeBaseDataSet();
...
FIN03041M00Component.prototype.onPlot8 = function() {
   // =================================================================
    // 자산구성비연도별그래프
    // =================================================================
    var dataSet = [];

    dataSet = FIN03041M00.setCostBaseDataSet();
...
FIN03041M00Component.prototype.setWallTrantPlot = function(dataSet) {
...
FIN03041M00Component.prototype.onPlot9 = function() {
...
FIN03041M00Component.prototype.onPlot10 = function() {
        // =================================================================
        // 자산구성비연도별그래프
        // =================================================================
        ...
        dataSet = FIN03041M00.setAddValueBaseDataSet();
...
function onStacYyChange01(event) {
        ...
        FIN03041M00.onFinRatioTableView();
...
function onStacYyChange03(event) {
        ...
        FIN03041M00.decisionRatioTable();
...
function onRadioClick(obj) {
        ...
        finService.getDecisionRatio(finCom.alyid, finCom.userid, finCom.bzn, lastest, enslDcd, FIN03041M00.decisionCallBack);

        wallTrantArray = [];

        finService.getWallTrantRatio(finCom.alyid, finCom.userid, finCom.bzn, lastest, enslDcd, FIN03041M00.wallTrantCallback);

        finService.getFinRatio(finCom.alyid, finCom.userid, finCom.bzn, lastest, enslDcd, FIN03041M00.finRateCallback);
