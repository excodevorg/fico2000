...
var FIN03114M00 = new FIN03114M00Component();
...
function FIN03114M00Component() {

};

FIN03114M00Component.prototype.ngOnInit = function () {
...
FIN03114M00Component.prototype.onSearch = function () {
        ...
        finService.getDecisionRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y","", FIN03114M00.decisionCallBack);
};


FIN03114M00Component.prototype.decisionCallBack = function (data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < res.data.stacYys.length; i++) {
                bsTable += FIN03114M00.onDesisionBaseTableView(i, res.data.stacYys[i].name);
            }
            ...
            finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y", enslDcd, FIN03114M00.finRateCallback);

            //FIN03114M00.decisionRatioTable();

            //finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, lastest, enslDcd, FIN03114M00.finRateCallback);
...
FIN03114M00Component.prototype.onDesisionBaseTableView = function(idx, stacYyName) {
...
FIN03114M00Component.prototype.decisionRatioTable = function(idx) {
...
FIN03114M00Component.prototype.finRateCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < decisionSet.stacYys.length; i++) {
                ...
                FIN03114M00.decisionRatioTable(i);
...
FIN03114M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03114M00Component.prototype.onFinResult = function () {
