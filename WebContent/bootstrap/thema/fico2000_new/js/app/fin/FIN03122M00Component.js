...
var FIN03113M00 = new FIN03113M00Component();
...
function FIN03113M00Component() {

};

FIN03113M00Component.prototype.ngOnInit = function () {
...
FIN03113M00Component.prototype.onSearch = function () {
        ...
        finService.getDecisionRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y","", FIN03113M00.decisionCallBack);
};


FIN03113M00Component.prototype.decisionCallBack = function (data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < res.data.stacYys.length; i++) {
                bsTable += FIN03113M00.onDesisionBaseTableView(i, res.data.stacYys[i].name);
            }
            ...
            finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y", enslDcd, FIN03113M00.finRateCallback);

            //FIN03113M00.decisionRatioTable();

            //finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, lastest, enslDcd, FIN03113M00.finRateCallback);
...
FIN03113M00Component.prototype.onDesisionBaseTableView = function(idx, stacYyName) {
...
FIN03113M00Component.prototype.decisionRatioTable = function(idx) {
    ...
    if (decsafeArray[i].finresult == 'BAD') decisionRatioTable += "<td style='cursor:pointer;'><span title='(기) "+safeArray[i].finRatio+" vs (한) "+safeArray[i].bokAllRatio+"' class='label label-table label-danger'>"+decsafeArray[i].bokresult+"</span></td>";
    if (decsafeArray[i].finresult == 'GOOD') decisionRatioTable += "<td style='cursor:pointer;'><span title='(기) "+safeArray[i].finRatio+" vs (한) "+safeArray[i].bokAllRatio+"' class='label label-table label-success'>"+decsafeArray[i].bokresult+"</span></td>";
    decisionRatioTable += "  </tr>                                                                                                         ";    
    }
...
FIN03113M00Component.prototype.finRateCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < decisionSet.stacYys.length; i++) {
                ...
                FIN03113M00.decisionRatioTable(i);
...
FIN03113M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03113M00Component.prototype.onFinResult = function () {
