...
var FIN03031M00 = new FIN03031M00Component();
...
function FIN03031M00Component() {

};

FIN03031M00Component.prototype.ngOnInit = function () {
...
FIN03031M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03031M00.finAnalyCallback);


};


FIN03031M00Component.prototype.finAnalyCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            alyDataSet.forEach(function(selectedRaw, index) {
                ...
                FIN03031M00.onBalance(selectedRaw);
                FIN03031M00.onIncome(selectedRaw);
                FIN03031M00.onCost(selectedRaw);
                FIN03031M00.onAddedValue(selectedRaw);

                bsTable += FIN03031M00.onBsTableView(index);
...
FIN03031M00Component.prototype.onBalance = function(res) {
...
FIN03031M00Component.prototype.onIncome = function(res) {
...
FIN03031M00Component.prototype.onCost = function(res) {
...
FIN03031M00Component.prototype.onAddedValue = function(res) {
    ...
    FIN03031M00.setAddValue();

};

FIN03031M00Component.prototype.setAddValue = function() {
...
FIN03031M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03031M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03031M00Component.prototype.getBsTotal = function(accd) {
...
FIN03031M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03031M00Component.prototype.getCostTotal = function(accd) {
...
FIN03031M00Component.prototype.onBsTableView = function(idx) {
    ...
    bsTable += '<h3 class="panel-title">매출 및 손익 ('+finAplyCom.stacYys[idx]+' 재무정보)</h3>';
    bsTable += '</div>';
    bsTable += '<div class="panel-body">'

    bsTable += '<table class="table table-condensed">';
    bsTable += '<thead>';
    bsTable += '<tr>';
    bsTable += '<th>항목</th>';
    bsTable += '<th>금액(<span name="'+finAplyCom.amtUnitNm+'"/>)</th>';
    bsTable += '</tr>';
    bsTable += '</thead>';
    bsTable += '<tbody>';
    ...
    bsTable += "     <td>매출액</td>                                    ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('FAS0302010101')+"</td>      ";
    bsTable += " </tr>                                                 ";
    bsTable += " <tr class='active'>                                   ";
    bsTable += "     <td>매출원가</td>                                  ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('FAS0302010102')+"</td>      ";
    bsTable += " </tr>                                                 ";
    bsTable += " <tr class='active'>                                   ";
    bsTable += "     <td>매출총손익</td>                                ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('amslTtalPlAmt')+"</td>      ";
    bsTable += " </tr>                                                 ";
    bsTable += " <tr class='active'>                                   ";
    bsTable += "     <td>판매비와관리비</td>                             ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('FAS03020201')+"</td>      ";
    bsTable += " </tr>                                                 ";

    for (var i = 0; i < FAS03020201s.length; i++) {
    bsTable += "  <tr>															                                                ";
    bsTable += "      <td>"+FAS03020201s[i].finSmdcdNm+"</td>                                                                   ";
    bsTable += "      <td>"+FIN03031M00.onNumberWithCommas(FAS03020201s[i].finAmt)+"</td>                                       ";
    bsTable += "  </tr>                                                                                                         ";    
    }

    bsTable += " <tr class='active'>                                   ";
    bsTable += "     <td>영업손익</td>                                  ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('bsopPlAmt')+"</td>      ";
    bsTable += " </tr>                                                 ";
    bsTable += "                                                       ";
    bsTable += " <tr class='active'>                                   ";
    bsTable += "     <td>영업외수익</td>                                ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('FAS03020301')+"</td>      ";
    bsTable += " </tr>                                                 ";

    for (var i = 0; i < FAS03020301s.length; i++) {
    bsTable += "  <tr>															                                                ";
    bsTable += "      <td>"+FAS03020301s[i].finSmdcdNm+"</td>                                                                   ";
    bsTable += "      <td>"+FIN03031M00.onNumberWithCommas(FAS03020301s[i].finAmt)+"</td>                                       ";
    bsTable += "  </tr>                                                                                                         ";    
    }

    bsTable += " <tr class='active'>                                   ";
    bsTable += "     <td>영업외비용</td>                                ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('FAS03020401')+"</td>      ";
    bsTable += " </tr>                                                 ";

    for (var i = 0; i < FAS03020401s.length; i++) {
    bsTable += "  <tr>															                                                ";
    bsTable += "      <td>"+FAS03020401s[i].finSmdcdNm+"</td>                                                                   ";
    bsTable += "      <td>"+FIN03031M00.onNumberWithCommas(FAS03020401s[i].finAmt)+"</td>                                       ";
    bsTable += "  </tr>                                                                                                         ";    
    }

    bsTable += " <tr class='active'>                                   ";
    bsTable += "     <td>법인세차감전순손익</td>                          ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('crtxSbbfNtprAmt')+"</td>      ";
    bsTable += " </tr>                                                 ";
    bsTable += " <tr class='active'>                                   ";
    bsTable += "     <td>법인세비용</td>                                ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('FAS03020501')+"</td>      ";
    bsTable += " </tr>                                                 ";
    bsTable += " <tr class='active'>                                   ";
    bsTable += "     <td>당기순손익</td>                                ";
    bsTable += "     <td>"+FIN03031M00.getIncomeTotal('crtrNtPlAmt')+"</td>      ";
    bsTable += " </tr>                                                 ";
...
FIN03031M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03031M00Component.prototype.onFinResult = function () {
