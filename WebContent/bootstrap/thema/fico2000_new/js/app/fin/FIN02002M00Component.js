...
FIN02002M00Component.prototype.onAddView = function() {
    ...
    $("#BsTotal_FAS030101G").html(FIN02002M00.getBsTotal('FAS030101G'));
...
FIN02002M00Component.prototype.finInputList = function(resArr) {
    ...
    for (var i = 0; i < resArr.length; i++) {
        ...
        html += '<input type="number" min="0" max="9999999999999" size="13" class="form-control" value="'+ resArr[i].finAmt +'" name="' + resArr[i].finMdvcd + '" id="'+ resArr[i].finSmdcd +'" placeholder="0" lang="nb" style="width:80%">';
        html += '</div>';
        html += '</div>';
    }
