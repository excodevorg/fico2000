...
var FIN03011M00 = new FIN03011M00Component();
...
function FIN03011M00Component() {

};

FIN03011M00Component.prototype.ngOnInit = function () {
...
FIN03011M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03011M00.finAnalyCallback);


};


FIN03011M00Component.prototype.finAnalyCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            alyDataSet.forEach(function(selectedRaw, index) {
                ...
                FIN03011M00.onBalance(selectedRaw);
                FIN03011M00.onIncome(selectedRaw);
                FIN03011M00.onCost(selectedRaw);
                FIN03011M00.onAddedValue(selectedRaw);

                bsTable += FIN03011M00.onDebtTableView(index);
...
FIN03011M00Component.prototype.onBalance = function(res) {
...
FIN03011M00Component.prototype.onIncome = function(res) {
...
FIN03011M00Component.prototype.onCost = function(res) {
...
FIN03011M00Component.prototype.onAddedValue = function(res) {
    ...
    FIN03011M00.setAddValue();

};

FIN03011M00Component.prototype.setAddValue = function() {
...
FIN03011M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03011M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03011M00Component.prototype.getBsTotal = function(accd) {
...
FIN03011M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03011M00Component.prototype.getCostTotal = function(accd) {
...
FIN03011M00Component.prototype.onDebtTableView = function(idx) {
    ...
    if (rowStartCount == 0) debtTable += '<div class="row" name="bsDiv" style="margin-top:10px;">';

    debtTable += '<div class="col-lg-4">';
    debtTable += '<div class="panel">';
    debtTable += '<div class="panel-heading">';
    debtTable += '<h3 class="panel-title">부채 및 자본 ('+finAplyCom.stacYys[idx]+' 재무정보)</h3>';
    debtTable += '</div>';
    debtTable += '<div class="panel-body">';
    debtTable += '<table id="bsTable" class="table  table-condensed">';
    debtTable += '<thead>';
    debtTable += '<tr>';
    debtTable += '<th>항목</th>';
    debtTable += '<th>금액(<span name="'+finAplyCom.amtUnitNm+'"/>)</th>';
    debtTable += '</tr>';
    debtTable += '</thead>';
    debtTable += '<tbody>';
    ...
    debtTable += "    <td style='background-color:#ffa31c;color:#fff;'>"+FIN03011M00.getBsTotal('FAS030103')+"</td>     ";
    debtTable += "</tr>                                                                                       ";
    ...
    debtTable += "      <td>"+FIN03011M00.onNumberWithCommas(FAS03010301s[i].finAmt)+"</td>                                       ";
    debtTable += "  </tr>                                                                                                         ";    
    }
    debtTable += "<tr class='active'>                                                                         ";
    debtTable += "    <td style='background-color:#00bcd4;color:#fff;'>비유동부채</td>                         ";
    debtTable += "    <td style='background-color:#00bcd4;color:#fff;'>"+FIN03011M00.getBsTotal('FAS030104')+"</td>      ";
    debtTable += "</tr>                                                                                       ";
    for (var i = 0; i < FAS03010401s.length; i++) {
    debtTable += "  <tr>															                                                ";
    debtTable += "      <td>"+FAS03010401s[i].finSmdcdNm+"</td>                                                                   ";
    debtTable += "      <td>"+FIN03011M00.onNumberWithCommas(FAS03010401s[i].finAmt)+"</td>                                       ";
    debtTable += "  </tr>                                                                                                         ";    
    }
    debtTable += "<tr class='active'>                                                                         ";
    debtTable += "    <td style='background-color:#a6c600;color:#fff;'>자본</td>                               ";
    debtTable += "    <td style='background-color:#a6c600;color:#fff;'>"+FIN03011M00.getBsTotal('FAS030105')+"</td>     ";
    debtTable += "</tr>                                                                                       ";
    for (var i = 0; i < FAS03010501s.length; i++) {
    debtTable += "  <tr>															                                                ";
    debtTable += "      <td>"+FAS03010501s[i].finSmdcdNm+"</td>                                                                   ";
    debtTable += "      <td>"+FIN03011M00.onNumberWithCommas(FAS03010501s[i].finAmt)+"</td>                                       ";
    debtTable += "  </tr>                                                                                                         ";    
    }
    debtTable += "<tr class='active'>                                                                         ";
    debtTable += "    <td>부채 및 자본 합계</td>                                                                ";
    debtTable += "    <td>"+FIN03011M00.getBsTotal('FAS030103T')+"</td>                                                 ";
    debtTable += "</tr>                                                                                       ";
...
FIN03011M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03011M00Component.prototype.onFinResult = function () {
