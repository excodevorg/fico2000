...
var FIN03002M00 = new FIN03002M00Component();
...
function FIN03002M00Component() {

};

FIN03002M00Component.prototype.ngOnInit = function () {
...
FIN03002M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03002M00.finAnalyCallback);


};


FIN03002M00Component.prototype.finAnalyCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            alyDataSet.forEach(function(selectedRaw, index) {
                ...
                FIN03002M00.onBalance(selectedRaw);
                FIN03002M00.onIncome(selectedRaw);
                FIN03002M00.onCost(selectedRaw);
                FIN03002M00.onAddedValue(selectedRaw);

                bsTable += FIN03002M00.onBsPlotView(index);
...
FIN03002M00Component.prototype.onBalance = function(res) {
...
FIN03002M00Component.prototype.onIncome = function(res) {
...
FIN03002M00Component.prototype.onCost = function(res) {
...
FIN03002M00Component.prototype.onAddedValue = function(res) {
    ...
    FIN03002M00.setAddValue();

};

FIN03002M00Component.prototype.setAddValue = function() {
...
FIN03002M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03002M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03002M00Component.prototype.getBsTotal = function(accd) {
...
FIN03002M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03002M00Component.prototype.getCostTotal = function(accd) {
...
FIN03002M00Component.prototype.onPlot1 = function(idx) {
...
*/
   console.log('bs-donut'+idx, dataSet);
   $.plot('#bs-donut'+idx, dataSet, {
       series: {
           pie: {
               show: true,
               combine: {
...
FIN03002M00Component.prototype.onBsPlotView = function(idx) {
    ...
    bsTable += '<h3 class="panel-title">자산 구성비('+finAplyCom.stacYys[idx]+' 재무정보)</h3>';
    bsTable += '</div>';
    bsTable += '<div class="panel-body">';
    bsTable += '<div id="bs-donut'+idx+'" style="width:100%;height:300px"></div>';
    bsTable += '</div>';
    bsTable += '</div>';
    bsTable += '</div>';
...
FIN03002M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03002M00Component.prototype.onFinResult = function () {
