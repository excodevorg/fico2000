...
var FIN03141M00 = new FIN03141M00Component();
...
function FIN03141M00Component() {

};

FIN03141M00Component.prototype.ngOnInit = function () {
...
FIN03141M00Component.prototype.onSearch = function () {
        ...
        finService.getDecisionRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y","", FIN03141M00.decisionCallBack);
};


FIN03141M00Component.prototype.decisionCallBack = function (data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y", enslDcd, FIN03141M00.finRateCallback);

            //FIN03141M00.decisionRatioTable();

            //finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, lastest, enslDcd, FIN03141M00.finRateCallback);
...
FIN03141M00Component.prototype.onFinRateBaseTableView = function(idx, stacYyName) {
    ...
    bsTable += '<h3 class="panel-title">표준재무비율 (<span name="enslDcdNm"/>) <h3>';
    bsTable += '</div>';
...
FIN03141M00Component.prototype.onFinRatioTableView = function(idx) {
...
FIN03141M00Component.prototype.finRateCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < decisionSet.stacYys.length; i++) {
                bsTable += FIN03141M00.onFinRateBaseTableView(i, decisionSet.stacYys[i].name);
            }
            ...
            for (var i = 0; i < decisionSet.stacYys.length; i++) {
                ...
                FIN03141M00.onFinRatioTableView(i);
...
FIN03141M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03141M00Component.prototype.onFinResult = function () {
