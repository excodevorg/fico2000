...
var FIN03131M00 = new FIN03131M00Component();
...
function FIN03131M00Component() {

};

FIN03131M00Component.prototype.ngOnInit = function () {
...
FIN03131M00Component.prototype.onSearch = function () {
        ...
        finService.getDecisionRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y","", FIN03131M00.decisionCallBack);
};


FIN03131M00Component.prototype.decisionCallBack = function (data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, "Y", enslDcd, FIN03131M00.finRateCallback);

            //FIN03131M00.decisionRatioTable();

            //finService.getFinRatio(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, lastest, enslDcd, FIN03131M00.finRateCallback);
...
FIN03131M00Component.prototype.onFinRateBaseTableView = function(idx, stacYyName) {
    ...
    bsTable += '<h3 class="panel-title"><span name="entpName"/> 재무비율</h3>';
    bsTable += '</div>';
...
FIN03131M00Component.prototype.onFinRatioTableView = function(idx) {
    ...
    finRatioTable += "  </tr>                                                                                                         ";    
        ...
        $('#finRatioTable'+idx+' > tbody:last').append(finRatioTable);
    };

FIN03131M00Component.prototype.finRateCallback = function(data) {
    ...
    if (data != null) {
        ...
        if (res.success) {
            ...
            for (var i = 0; i < decisionSet.stacYys.length; i++) {
                bsTable += FIN03131M00.onFinRateBaseTableView(i, decisionSet.stacYys[i].name);
            }
            ...
            for (var i = 0; i < decisionSet.stacYys.length; i++) {
                ...
                FIN03131M00.onFinRatioTableView(i);
...
FIN03131M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03131M00Component.prototype.onFinResult = function () {
