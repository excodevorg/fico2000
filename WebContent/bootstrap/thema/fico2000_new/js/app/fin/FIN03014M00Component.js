...
var FIN03014M00 = new FIN03014M00Component();
...
function FIN03014M00Component() {

};

FIN03014M00Component.prototype.ngOnInit = function () {
...
FIN03014M00Component.prototype.onSearch = function () {
        ...
        finService.getAnalysisFinDtTypeMaps(finAplyCom.alyid, finAplyCom.userid, finAplyCom.bzn, finAplyCom.stacYys, FIN03014M00.finAnalyCallback);


};


FIN03014M00Component.prototype.finAnalyCallback = function(data) {
...
FIN03014M00Component.prototype.onBalance = function(res) {
...
FIN03014M00Component.prototype.onIncome = function(res) {
...
FIN03014M00Component.prototype.onCost = function(res) {
...
FIN03014M00Component.prototype.onAddedValue = function(res) {
    ...
    FIN03014M00.setAddValue();

};

FIN03014M00Component.prototype.setAddValue = function() {
...
FIN03014M00Component.prototype.getAddValue01 = function(accd, idx) {
...
FIN03014M00Component.prototype.getAddValueTotal = function(accd) {
...
FIN03014M00Component.prototype.getBsTotal = function(accd) {
...
FIN03014M00Component.prototype.getIncomeTotal = function(accd) {
...
FIN03014M00Component.prototype.getCostTotal = function(accd) {
...
FIN03014M00Component.prototype.setBalanceDataSet01 = function() {
    ...
    dataSet = FIN03014M00.setDataSet(arr, dataSet);
    dataSet = FIN03014M00.setDataSet(arr1, dataSet);
    dataSet = FIN03014M00.setDataSet(arr2, dataSet);
...
FIN03014M00Component.prototype.setDataSet = function(arr, dataSet) {
...
FIN03014M00Component.prototype.onPlot2 = function() {
    ...
    dataSet = FIN03014M00.setBalanceDataSet01();
...
FIN03014M00Component.prototype.onNumberWithCommas = function (totalAmt) {
    return numberWithCommas(totalAmt);
};

FIN03014M00Component.prototype.onFinResult = function () {
