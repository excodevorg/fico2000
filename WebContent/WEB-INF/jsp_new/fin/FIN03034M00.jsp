...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
               <div id="page-title">
                    <h1 class="page-header text-overflow"> 매출액 대비 손익계산서 연도별 추세분석</h1>
                        ...
                        <div class="col-lg-12">                                                            
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                            <div id="incomeLine" style="width:100%;height:600px;"></div>
                                    </div>
                                </div>
                        </div>
                        <!-- //자산구성비연도별 -->
             ...
             <div id="popup" class="Pstyle" data-backdrop="static" data-keyboard="false">
                 ...
                 <script src="/bootstrap/thema/fico2000_new/js/app/fin/FIN03034M00Component.js"></script>   
