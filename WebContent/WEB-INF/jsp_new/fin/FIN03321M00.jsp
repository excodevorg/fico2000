...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow"> 연간 재무·투자활동 성과 진단  > 경영성과상태 예측</h1>
                    ...
                    <div class="searchbox"  style="width:350px;">
                        <div class="input-group custom-search-form">
                            <ul class="pull-right breadcrumb">
                                ...
                                <li>재무·투자활동현금흐름</li>
                                <li class="active">연간 재무·투자활동 성과 진단</li>
                            </ul>
                        </div>
                    </div>
                </div>   
                            ...
                            <div class="col-lg-12">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">1년간 현금흐름이 경영활동에 미치는 결과</h3>  
                                    </div>
                ...
                <div id="popup" class="Pstyle" data-backdrop="static" data-keyboard="false">
                 ...
                 <script src="/bootstrap/thema/fico2000_new/js/app/fin/FIN03321M00Component.js"></script>   
