...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow"> 자산부문 현황 > 당좌·재고·유형·기타자산 연도별추세분석</h1>
                            ...
                            <div class="col-lg-12">                                                            
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            <div id="bs-line" style="width:100%;height:600px;"></div>
                                        </div>
                                    </div>
                            </div>
                            <!-- //자산구성비연도별 -->
             ...
             <div id="popup" class="Pstyle" data-backdrop="static" data-keyboard="false">
                 ...
                 <script src="/bootstrap/thema/fico2000_new/js/app/fin/FIN03003M00Component.js"></script>   
