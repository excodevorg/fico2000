...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
               <div id="page-title">
                    <h1 class="page-header text-overflow"> 제조원가 현황 연도별 추세분석</h1>
                    ...
                    <div class="searchbox" style="width: 385px;">
                        <div class="input-group custom-search-form">
                            <ul class="pull-right breadcrumb">
                                ...
                                <li>기업재무현황추세분석</li>
                                <li class="active">제조원가 현황 연도별 추세분석</li>
                            </ul>
                        </div>
                    </div>
                </div>     
                        ...
                        <div class="col-lg-12">                                                            
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">제조원가 현황 연도별 추세분석</h3>
                                    </div>
                                    <div class="panel-body">
                                            <div id="costLine" style="width:100%;height:600px;"></div>
                                    </div>
                                </div>
                        </div>
                        <!-- //자산구성비연도별 -->
             ...
             <div id="popup" class="Pstyle" data-backdrop="static" data-keyboard="false">
                 ...
                 <script src="/bootstrap/thema/fico2000_new/js/app/fin/FIN03051M00Component.js"></script>   
