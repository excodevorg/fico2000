...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow"> 연간 비즈니스 성과 진단 > 경영성과상태 예측</h1>

                    <!--Searchbox-->
                    <div class="searchbox"  style="width:400px;">
                        <div class="input-group custom-search-form">
                            <ul class="pull-right breadcrumb">
                                <li><a href="index.html">Home</a></li>
                                <li>비즈니스모델현금흐름</li>
                                <li class="active">연간비즈니스성과진단</li>
                            </ul>
                        </div>
                    </div>
                </div>   
...
\                
                 <script src="/bootstrap/thema/fico2000_new/js/app/fin/FIN03231M00Component.js"></script>   
