...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
               ...
               <!--Page Title-->
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow"> 재무상태표총괄추세 분석</h1>
                    ...
                    <div class="searchbox" style="width:350px;">
                        <div class="input-group custom-search-form">
                            <ul class="pull-right breadcrumb">
                                ...
                                <li>기업재무현황추세분석</li>
                                <li class="active">재무상태표총괄추세분석</li>
                            </ul>
                        </div>
                    </div>
                </div>   
                ...
                <div id="page-content">
                    ...
                    <div class="tab-base">
                        ...
                        <ul id="myTab" class="nav nav-tabs">
                            <li><a href="#balanceSheet" data-toggle="tab" class="text-lg"></a></li>
                        </ul>
...
<script src="/bootstrap/thema/fico2000_new/js/app/fin/FIN03021M00Component.js"></script>   
