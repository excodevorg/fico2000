...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow"> 현금흐름예측 > 현금 지출 연간 월별 예측</h1>
...
\                
                 <script src="/bootstrap/thema/fico2000_new/js/app/fin/FIN03216M00Component.js"></script>   
