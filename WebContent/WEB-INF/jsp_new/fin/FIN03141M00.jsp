...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow"> 기업종합검진 평가 > 재무비율(기업분류)</h1>
                ...
                <div id="popup" class="Pstyle" data-backdrop="static" data-keyboard="false">
                 ...
                 <script src="/bootstrap/thema/fico2000_new/js/app/fin/FIN03141M00Component.js"></script>   
