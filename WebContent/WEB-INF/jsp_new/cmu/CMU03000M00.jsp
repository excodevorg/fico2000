                            ...
                            <h3 class="panel-title">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td align="right">
                                        <button type="button" class="btn btn-primary" onClick="goBizPlate()">비지니스 Platform 업무범위코드</button></td>
                                    </tr>
                                </table>
                            </h3>
                        </div>
...
<script src="/bootstrap/thema/fico2000_new/js/app/cmu/CMU03000M00Component.js"></script>   