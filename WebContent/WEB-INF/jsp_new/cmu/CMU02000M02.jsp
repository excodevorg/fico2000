                 ...
                 <div id="page-content">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">자유게시판 조회</h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="mar-top bord-top">
                                        <div class="row">
                                            <div class="col-lg-10">
                                                <textarea id="selectedReplyBoards_content" rows=3 placeholder="댓글을 남겨주세요" style="width: 100%"></textarea>
                                            </div> 
                                            <div class="col-lg-2">
                                                <button class="btn btn-block btn-primary" id="onRelpySave">보내기</button>
                                                <button class="btn btn-block btn-darkgray" id="onRelpyCancle">취소</button>
                                            </div>
                                        </div>   
                                        <div class="row">
                                            <div id="replyView" style="margin-top: 10px">
...
<script src="/bootstrap/thema/fico2000_new/js/app/cmu/CMU02000M02Component.js"></script>   
