...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">자주묻는 질문</h1>
                 ...
                 <div id="page-content">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">자주묻는 질문 목록</h3>
                        </div>
...
<script src="/bootstrap/thema/fico2000_new/js/app/cmu/CMU01000M00Component.js"></script>   