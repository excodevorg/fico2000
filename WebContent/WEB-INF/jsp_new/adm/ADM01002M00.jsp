                            ...
                            <div class="row">
                                ...
                                <fieldset>                            
                                            ...
                                            <div class="row">
                                                ...
                                                <button class="btn btn-primary" type="button" id="onAddCode">코드등록</button>
                                                <button class="btn btn-default" type="button" id="onUpdCode">코드변경</button>
                                                <button class="btn btn-darkgray" type="button" id="onDelCode">코드삭제</button>
                                                </div>
                                            </div>
