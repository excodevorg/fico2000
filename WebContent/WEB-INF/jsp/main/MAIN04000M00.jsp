...
<!-- BACKGROUND IMAGE -->
            <!--===================================================-->
            <div id="bg-overlay" style='background-image: url("/bootstrap/thema/fico2000/img/bg-img/12.jpg");' class="bg-img"></div>
            ...
            <div class="cls-content" style="text-align:center;">
                <div class="cls-content-sm panel">
                    <div class="panel-body">
                        ...
                        <button class="btn btn-success btn-block" onClick="tempPasswardMake()">임시 비밀번호 발급</button><br>
