...
%>
    ...
    <!-- BACKGROUND IMAGE -->
		<!--===================================================-->
		<div id="bg-overlay" style='background-image: url("/bootstrap/thema/fico2000/img/bg-img/8.jpg");' class="bg-img"></div>
		...
		<div class="cls-content">
		    <div class="cls-content-lg panel">
		        <div class="panel-body">
					...
					<button class="btn btn-primary btn-block" id="btnReg">Register</button>
		        </div>
