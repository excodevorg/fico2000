...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">강의 내용 FAQ</h1>
                        ...
                        <div class="panel-body">
                            ...
                            <table id="grid-list" class="table table-condensed table-hover table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-column-id="relNo" data-visible="false">답글번호</th>
                                                <th data-column-id="lcteUnqId" data-visible="false">강의ID</th>
                                                <th data-column-id="numRow">순번</th>
                                                <th data-column-id="title" data-formatter="titleTypeRenderer">제 목</th>
                            ...
                            <div class="row">
                                ...
                                <form class="sky-form" role="form" id="ngForm" name="ngForm">
                                    <input type="hidden" class="form-control" name="lcteUnqId" id="lcteUnqId">
                                    <input type="hidden" class="form-control" name="code" id="code">
                                    <input type="hidden" class="form-control" name="mainNo" id="mainNo">
                                    ...
                                    <fieldset>                            
                                                ...
                                                <div class="row">
                                                    ...
                                                    <section class="col col-9">
                                                        <label class="input">
                                                            <textarea class="form-control" rows="5" id="rec-content" ></textarea>
                                                        </label>
                                                    </section>
                                                </div>   
                                                ...
                                                <div class="row">
                                                    <div style="float:right;margin-bottom:10px;margin-right:10px;">
                                                        <button class="btn-u btn-u-yellow" type="button" id="onReplyWrite">답글</button>
                                                        <button class="btn-u btn-u-yellow" type="button" id="onReplyWriteSave">답글저장</button>
                                                        <button class="btn-u btn-u-red" type="button" id="onModify">변경</button>
                                                        <button class="btn-u btn-u-aqua" type="button" id="onDel">삭제</button>
                                                    </div>
                                                </div>
...
<script src="/bootstrap/thema/fico2000/js/app/adm/ADM04004M00Component.js"></script>       