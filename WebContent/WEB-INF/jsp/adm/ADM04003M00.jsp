                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div style="float:right;margin-bottom:10px;margin-right:10px;">
                                        <button class="btn-u btn-u-yellow" type="button" id="onStartApply">승인</button>
                                        <button class="btn-u btn-u-yellow" type="button" id="onStopApply">반려</button>
                                        <button class="btn-u btn-u-red" type="button" id="onComplete">수료</button>
                                        <button class="btn-u btn-u-aqua" type="button" id="onNotComplete">미수료</button>
                                </div>
