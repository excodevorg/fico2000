                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div style="float:right;margin-bottom:10px;margin-right:10px;">
                                        <button class="btn-u btn-u-yellow" type="button" id="onStartUser">회원활성화</button>
                                        <button class="btn-u btn-u-yellow" type="button" id="onStopUser">회원중지</button>
                                        <button class="btn-u btn-u-red" type="button" id="onDropUser">회원탈퇴</button>
                                        <button class="btn-u btn-u-aqua" type="button" id="onInitialPwd">비밀번호 초기화</button>
                                </div>
