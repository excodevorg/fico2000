                 ...
                 <div id="page-content">
                    ...
                    <!-- Search Well -->
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Business Platform 답글</h3>
                        </div>                    
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="margin-bottom-20"></div>
                                        ...
                                        <input type="hidden" class="form-control" id="mainNo" name="mainNo" value='0'>
                                        <input type="hidden" class="form-control" id="relNo" name="relNo" value='<%=paramMap.get("relNo")%>'>
                                        ...
                                        <fieldset>                            
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <button class="btn-u btn-u-red" type="button" id="onGoList">목록</button>
                                                        <button class="btn-u btn-u-aqua" type="button" id="onSave">저장</button>
                                                        <button class="btn-u btn-u-yellow" type="button" id="onInit">초기화</button>
                                                        </div>
                                                    </div>
...
<script src="/bootstrap/thema/fico2000/js/app/adm/ADM05005M03Component.js"></script>