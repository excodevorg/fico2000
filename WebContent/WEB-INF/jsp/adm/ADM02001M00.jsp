                        ...
                        <div class="panel-body">
							...
							<fieldset>                            
										...
										<div class="row">
											...
											<button class="btn-u btn-u-yellow" type="button" id="onAddMenu">메뉴등록</button>
											<button class="btn-u btn-u-red" type="button" id="onUpdMenu">메뉴변경</button>
											<button class="btn-u btn-u-aqua" type="button" id="onDelMenu">메뉴삭제</button>
											</div>
										</div>
