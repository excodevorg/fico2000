                                ...
                                <form class="sky-form" role="form" id="ngForm" name="ngForm">
                                    ...
                                    <fieldset>                            
                                                ...
                                                <div class="row">
                                                    ...
                                                    <button class="btn-u btn-u-yellow" type="button" id="onAddLecture">강의등록</button>
                                                    <button class="btn-u btn-u-red" type="button" id="onUpdLecture">강의변경</button>
                                                    <button class="btn-u btn-u-aqua" type="button" id="onDelLecture">강의삭제</button>
                                                    </div>
                                                </div>
