                 ...
                 <div id="page-content">
                    ...
                    <!-- Search Well -->
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">Business Platform 수정</h3>
                        </div>                    
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="margin-bottom-20"></div>
                                        ...
                                        <input type="hidden" class="form-control" id="relNo" name="relNo">
                                        ...
                                        <fieldset>                            
                                                    ...
                                                    <div class="row">
                                                        <div style="float:right;margin-bottom:10px;margin-right:10px;">
                                                            ...
                                                            <button class="btn-u btn-u-yellow" type="button" id="onDel">삭제</button>
                                                        </div>
                                                    </div>
...
<script src="/bootstrap/thema/fico2000/js/app/adm/ADM05005M02Component.js"></script>   