...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">현금 흐름 분석</h1>
                </div>
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <!--End page title-->
                ...
                <div id="page-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">현금흐름분석</h3>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <a id="onFinResult" target="_self" class="btn btn-block btn-primary btn-lg" style="color:#fff;">현금 흐름 분석 결과보기 ></a>
                                </div>
                            <!--===================================================-->                                        
                            </div>
...
<script src="/bootstrap/thema/fico2000/js/app/fin/FIN03001M00Component.js"></script>   
