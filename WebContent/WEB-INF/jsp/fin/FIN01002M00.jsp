...
<%@include file="/inc/common.jsp" %>
            ...
            <div id="content-container">
                ...
                <!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
                <div id="page-title">
                    <h1 class="page-header text-overflow">기업관리 > 재무 정보</h1>
					            ...
					            <div id="demo-main-wz">
					                ...
					                <form class="form-horizontal">
					                        ...
					                        <div class="tab-content">
					                            ...
					                            <div id="demo-main-tab1" class="tab-pane">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <button type="button" class="finish btn btn-success" id="onSave1" disabled>Finish</button>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <div class="tab-content">
                                                                        ...
                                                                        <div class="tab-footer clearfix">
                                                                            <div class="col-lg-6 col-lg-offset-6">
                                                                                ...
                                                                                <button type="button" class="btn btn-success" id="saveFAS0301">저장</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
					                            ...
					                            <div id="demo-main-tab2" class="tab-pane fade">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <button type="button" class="previous btn btn-primary">Previous</button>
                                                        <button type="button" class="next btn btn-primary">Next</button>
                                                        <button type="button" class="finish btn btn-success" id="onSave2" disabled>Finish</button>
                                                    </div>
                                                    </div>
                                                    <div class="row">   
                                                        <div class="col-lg-1"></div>
                                                                    ...
                                                                    <div class="tab-content">
                                                                        ...
                                                                        <div class="tab-footer clearfix">
                                                                            <div class="col-lg-6 col-lg-offset-6">
                                                                                ...
                                                                                <button type="button" class="btn btn-success" id="saveFAS0302">저장</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
					                            ...
					                            <div id="demo-main-tab3" class="tab-pane">
					                                <div class="row">
                                                        ...
                                                        <button type="button" class="previous btn btn-primary">Previous</button>
                                                        <button type="button" class="next btn btn-primary">Next</button>
                                                        <button type="button" class="finish btn btn-success" id="onSave3" disabled>Finish</button>
                                                        </div>
                                                    </div>
                                                    <div class="row">    
                                                                    ...
                                                                    <div class="tab-content">
                                                                        ...
                                                                        <div class="tab-footer clearfix">
                                                                            <div class="col-lg-6 col-lg-offset-6">
                                                                                ...
                                                                                <button type="button" class="btn btn-success" id="saveFAS0303">저장</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
                                                ...
                                                <div id="demo-main-tab4" class="tab-pane">
					                                <div class="row">
                                                        ...
                                                        <button type="button" class="previous btn btn-primary">Previous</button>
                                                        <button type="button" class="next btn btn-primary">Next</button>
                                                        <button type="button" class="finish btn btn-success" id="onSave" disabled>Finish</button>
                                                        </div>
                                                    </div>
                                                    <div class="row"> 
                                                                    ...
                                                                    <div class="tab-content">
                                                                        ...
                                                                        <div class="tab-footer clearfix">
                                                                            <div class="col-lg-6 col-lg-offset-6">
                                                                                ...
                                                                                <button type="button" class="btn btn-success" id="saveFAS0304">저장</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
					                    ...
					                    <div class="pull-right pad-rgt mar-btm">
					                        <button type="button" class="previous btn btn-primary">Previous</button>
					                        <button type="button" class="next btn btn-primary">Next</button>
					                        <button type="button" class="finish btn btn-success" id="onSave01" disabled>Finish</button>
					                    </div>
					                </form>
					            </div>
					            <!--===================================================-->
...
<script src="/bootstrap/thema/fico2000/js/app/fin/FIN01002M00Component.js"></script>   