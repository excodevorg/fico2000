                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="mar-top bord-top">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-2">
                                                <button class="btn btn-block btn-primary" id="onRelpySave">보내기</button><button class="btn btn-block btn-primary" id="onRelpyCancle">취소</button>
                                            </div>
                                        </div>   
                                        <div class="row">
...
<script src="/bootstrap/thema/fico2000/js/app/cmu/CMU02000M02Component.js"></script>   
