...
public interface SvyItemDetailInfoRepository  extends JpaRepository<SvyItemDetailInfoDomain, String> {
	...
	@Query("select u from SvyItemDetailInfoDomain u where u.useYn = 'Y' and u.svyId = ?1 order by u.ord asc")
	public List<SvyItemDetailInfoDomain> findBySvyIdOrderByOrdAsc(String svyId);
