...
public class LcteMngFormVo extends CmmFormVo {
	...
	private String lcteYmd;
	
	private String lctePgrsScdNm;
	...
	public String getApplyPrgScdNm() {
		return applyPrgScdNm;
	}

	public void setApplyPrgScdNm(String applyPrgScdNm) {
		this.applyPrgScdNm = applyPrgScdNm;
	}
	...
	public String getLcteYmd() {
		return lcteYmd;
	}

	public void setLcteYmd(String lcteYmd) {
		this.lcteYmd = lcteYmd;
	}
	...
	public String getLctePgrsScdNm() {
		return lctePgrsScdNm;
	}

	public void setLctePgrsScdNm(String lctePgrsScdNm) {
		this.lctePgrsScdNm = lctePgrsScdNm;
	}
}
